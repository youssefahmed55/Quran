 ...
 * Use the {@link FragmentViewPages130#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages130 extends Fragment {
    ...
    public static FragmentViewPages130 newInstance(String param1, String param2) {
        FragmentViewPages130 fragment = new FragmentViewPages130();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page130, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page130);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear130);
