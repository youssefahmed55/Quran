 ...
 * Use the {@link FragmentViewPages597#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages597 extends Fragment {
    ...
    public static FragmentViewPages597 newInstance(String param1, String param2) {
        FragmentViewPages597 fragment = new FragmentViewPages597();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page597, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear597);
        linearLayout2 = viewGroup.findViewById(R.id.linear597_2);
        s = getActivity().getResources().getString(R.string.page597);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page597_2);
        views.clear();
