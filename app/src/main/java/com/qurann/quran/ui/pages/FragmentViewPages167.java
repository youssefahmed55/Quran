 ...
 * Use the {@link FragmentViewPages167#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages167 extends Fragment {
    ...
    public static FragmentViewPages167 newInstance(String param1, String param2) {
        FragmentViewPages167 fragment = new FragmentViewPages167();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page167, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page167);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear167);
