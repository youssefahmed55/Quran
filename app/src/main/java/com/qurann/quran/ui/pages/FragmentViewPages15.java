 ...
 * Use the {@link FragmentViewPages15#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages15 extends Fragment {
    ...
    public static FragmentViewPages15 newInstance(String param1, String param2) {
        FragmentViewPages15 fragment = new FragmentViewPages15();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page15, container, false);
        handleViews();
        return viewGroup;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page15);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear15);
