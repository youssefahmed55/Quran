 ...
 * Use the {@link FragmentViewPages391#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages391 extends Fragment {
    ...
    public static FragmentViewPages391 newInstance(String param1, String param2) {
        FragmentViewPages391 fragment = new FragmentViewPages391();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page391, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page391);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear391);
