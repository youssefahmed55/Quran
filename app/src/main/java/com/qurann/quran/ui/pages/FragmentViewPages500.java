 ...
 * Use the {@link FragmentViewPages500#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages500 extends Fragment {
    ...
    public static FragmentViewPages500 newInstance(String param1, String param2) {
        FragmentViewPages500 fragment = new FragmentViewPages500();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page500, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page500);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear500);
