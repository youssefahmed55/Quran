 ...
 * Use the {@link FragmentViewPages56#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages56 extends Fragment {
    ...
    public static FragmentViewPages56 newInstance(String param1, String param2) {
        FragmentViewPages56 fragment = new FragmentViewPages56();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page56, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page56);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear56);
