 ...
 * Use the {@link FragmentViewPages350#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages350 extends Fragment {
    ...
    public static FragmentViewPages350 newInstance(String param1, String param2) {
        FragmentViewPages350 fragment = new FragmentViewPages350();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page350, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page350);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear350);
