 ...
 * Use the {@link FragmentViewPages138#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages138 extends Fragment {
    ...
    public static FragmentViewPages138 newInstance(String param1, String param2) {
        FragmentViewPages138 fragment = new FragmentViewPages138();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page138, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page138);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear138);
