 ...
 * Use the {@link FragmentViewPages352#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages352 extends Fragment {
    ...
    public static FragmentViewPages352 newInstance(String param1, String param2) {
        FragmentViewPages352 fragment = new FragmentViewPages352();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page352, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page352);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear352);
