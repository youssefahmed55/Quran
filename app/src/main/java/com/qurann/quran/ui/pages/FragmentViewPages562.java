 ...
 * Use the {@link FragmentViewPages562#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages562 extends Fragment {
    ...
    public static FragmentViewPages562 newInstance(String param1, String param2) {
        FragmentViewPages562 fragment = new FragmentViewPages562();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page562, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page562);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear562);
