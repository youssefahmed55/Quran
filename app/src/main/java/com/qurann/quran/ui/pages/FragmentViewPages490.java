 ...
 * Use the {@link FragmentViewPages490#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages490 extends Fragment {
    ...
    public static FragmentViewPages490 newInstance(String param1, String param2) {
        FragmentViewPages490 fragment = new FragmentViewPages490();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page490, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page490);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear490);
