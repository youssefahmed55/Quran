 ...
 * Use the {@link FragmentViewPages97#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages97 extends Fragment {
    ...
    public static FragmentViewPages97 newInstance(String param1, String param2) {
        FragmentViewPages97 fragment = new FragmentViewPages97();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page97, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page97);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear97);
