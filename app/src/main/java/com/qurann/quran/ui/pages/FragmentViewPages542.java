 ...
 * Use the {@link FragmentViewPages542#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages542 extends Fragment {
    ...
    public static FragmentViewPages542 newInstance(String param1, String param2) {
        FragmentViewPages542 fragment = new FragmentViewPages542();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page542, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page542);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear542);
