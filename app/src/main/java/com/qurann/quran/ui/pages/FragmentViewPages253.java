 ...
 * Use the {@link FragmentViewPages253#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages253 extends Fragment {
    ...
    public static FragmentViewPages253 newInstance(String param1, String param2) {
        FragmentViewPages253 fragment = new FragmentViewPages253();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page253, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page253);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear253);
