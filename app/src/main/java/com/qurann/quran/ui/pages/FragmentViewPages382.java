 ...
 * Use the {@link FragmentViewPages382#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages382 extends Fragment {
    ...
    public static FragmentViewPages382 newInstance(String param1, String param2) {
        FragmentViewPages382 fragment = new FragmentViewPages382();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page382, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page382);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear382);
