 ...
 * Use the {@link FragmentViewPages67#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages67 extends Fragment {
    ...
    public static FragmentViewPages67 newInstance(String param1, String param2) {
        FragmentViewPages67 fragment = new FragmentViewPages67();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page67, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page67);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear67);
