 ...
 * Use the {@link FragmentViewPages404#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages404 extends Fragment {
    ...
    public static FragmentViewPages404 newInstance(String param1, String param2) {
        FragmentViewPages404 fragment = new FragmentViewPages404();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page404, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear404);
        linearLayout2 = viewGroup.findViewById(R.id.linear404_2);
        s = getActivity().getResources().getString(R.string.page404);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page404_2);
        views.clear();
