 ...
 * Use the {@link FragmentViewPages525#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages525 extends Fragment {
    ...
    public static FragmentViewPages525 newInstance(String param1, String param2) {
        FragmentViewPages525 fragment = new FragmentViewPages525();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page525, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page525);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear525);
