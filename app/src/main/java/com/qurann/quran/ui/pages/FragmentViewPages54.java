 ...
 * Use the {@link FragmentViewPages54#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages54 extends Fragment {
    ...
    public static FragmentViewPages54 newInstance(String param1, String param2) {
        FragmentViewPages54 fragment = new FragmentViewPages54();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page54, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page54);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear54);
