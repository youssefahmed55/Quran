 ...
 * Use the {@link FragmentViewPages472#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages472 extends Fragment {
    ...
    public static FragmentViewPages472 newInstance(String param1, String param2) {
        FragmentViewPages472 fragment = new FragmentViewPages472();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page472, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page472);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear472);
