 ...
 * Use the {@link FragmentViewPages389#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages389 extends Fragment {
    ...
    public static FragmentViewPages389 newInstance(String param1, String param2) {
        FragmentViewPages389 fragment = new FragmentViewPages389();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page389, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page389);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear389);
