 ...
 * Use the {@link FragmentViewPages207#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages207 extends Fragment {
    ...
    public static FragmentViewPages207 newInstance(String param1, String param2) {
        FragmentViewPages207 fragment = new FragmentViewPages207();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page207, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page207);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear207);
