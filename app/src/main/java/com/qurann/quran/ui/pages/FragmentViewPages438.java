 ...
 * Use the {@link FragmentViewPages438#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages438 extends Fragment {
    ...
    public static FragmentViewPages438 newInstance(String param1, String param2) {
        FragmentViewPages438 fragment = new FragmentViewPages438();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page438, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page438);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear438);
