 ...
 * Use the {@link FragmentViewPages55#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages55 extends Fragment {
    ...
    public static FragmentViewPages55 newInstance(String param1, String param2) {
        FragmentViewPages55 fragment = new FragmentViewPages55();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page55, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page55);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear55);
