 ...
 * Use the {@link FragmentViewPages423#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages423 extends Fragment {
    ...
    public static FragmentViewPages423 newInstance(String param1, String param2) {
        FragmentViewPages423 fragment = new FragmentViewPages423();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page423, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page423);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear423);
