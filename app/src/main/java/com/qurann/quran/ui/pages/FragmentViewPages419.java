 ...
 * Use the {@link FragmentViewPages419#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages419 extends Fragment {
    ...
    public static FragmentViewPages419 newInstance(String param1, String param2) {
        FragmentViewPages419 fragment = new FragmentViewPages419();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page419, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page419);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear419);
