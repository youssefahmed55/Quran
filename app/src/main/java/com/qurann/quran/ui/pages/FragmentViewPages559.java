 ...
 * Use the {@link FragmentViewPages559#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages559 extends Fragment {
    ...
    public static FragmentViewPages559 newInstance(String param1, String param2) {
        FragmentViewPages559 fragment = new FragmentViewPages559();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page559, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page559);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear559);
