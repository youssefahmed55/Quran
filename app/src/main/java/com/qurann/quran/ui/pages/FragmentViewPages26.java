 ...
 * Use the {@link FragmentViewPages26#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages26 extends Fragment {
    ...
    public static FragmentViewPages26 newInstance(String param1, String param2) {
        FragmentViewPages26 fragment = new FragmentViewPages26();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page26, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page26);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear26);
