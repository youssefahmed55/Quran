 ...
 * Use the {@link FragmentViewPages72#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages72 extends Fragment {
    ...
    public static FragmentViewPages72 newInstance(String param1, String param2) {
        FragmentViewPages72 fragment = new FragmentViewPages72();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page72, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page72);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear72);
