 ...
 * Use the {@link FragmentViewPages463#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages463 extends Fragment {
    ...
    public static FragmentViewPages463 newInstance(String param1, String param2) {
        FragmentViewPages463 fragment = new FragmentViewPages463();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page463, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page463);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear463);
