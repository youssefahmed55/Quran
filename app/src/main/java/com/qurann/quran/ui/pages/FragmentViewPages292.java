 ...
 * Use the {@link FragmentViewPages292#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages292 extends Fragment {
    ...
    public static FragmentViewPages292 newInstance(String param1, String param2) {
        FragmentViewPages292 fragment = new FragmentViewPages292();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page292, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page292);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear292);
