 ...
 * Use the {@link FragmentViewPages160#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages160 extends Fragment {
    ...
    public static FragmentViewPages160 newInstance(String param1, String param2) {
        FragmentViewPages160 fragment = new FragmentViewPages160();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page160, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page160);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear160);
