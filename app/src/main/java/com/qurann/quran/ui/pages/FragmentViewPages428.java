 ...
 * Use the {@link FragmentViewPages428#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages428 extends Fragment {
    ...
    public static FragmentViewPages428 newInstance(String param1, String param2) {
        FragmentViewPages428 fragment = new FragmentViewPages428();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page428, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page428);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear428);
