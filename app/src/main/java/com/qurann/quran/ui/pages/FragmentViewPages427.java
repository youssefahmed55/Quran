 ...
 * Use the {@link FragmentViewPages427#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages427 extends Fragment {
    ...
    public static FragmentViewPages427 newInstance(String param1, String param2) {
        FragmentViewPages427 fragment = new FragmentViewPages427();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page427, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page427);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear427);
