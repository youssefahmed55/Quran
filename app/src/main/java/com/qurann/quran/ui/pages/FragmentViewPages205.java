 ...
 * Use the {@link FragmentViewPages205#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages205 extends Fragment {
    ...
    public static FragmentViewPages205 newInstance(String param1, String param2) {
        FragmentViewPages205 fragment = new FragmentViewPages205();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page205, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page205);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear205);
