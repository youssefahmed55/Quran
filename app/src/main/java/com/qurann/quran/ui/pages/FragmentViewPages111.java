 ...
 * Use the {@link FragmentViewPages111#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages111 extends Fragment {
    ...
    public static FragmentViewPages111 newInstance(String param1, String param2) {
        FragmentViewPages111 fragment = new FragmentViewPages111();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page111, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page111);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear111);
