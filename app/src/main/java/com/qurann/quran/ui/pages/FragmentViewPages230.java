 ...
 * Use the {@link FragmentViewPages230#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages230 extends Fragment {
    ...
    public static FragmentViewPages230 newInstance(String param1, String param2) {
        FragmentViewPages230 fragment = new FragmentViewPages230();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page230, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page230);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear230);
