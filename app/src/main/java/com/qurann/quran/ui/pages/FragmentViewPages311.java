 ...
 * Use the {@link FragmentViewPages311#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages311 extends Fragment {
    ...
    public static FragmentViewPages311 newInstance(String param1, String param2) {
        FragmentViewPages311 fragment = new FragmentViewPages311();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page311, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page311);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear311);
