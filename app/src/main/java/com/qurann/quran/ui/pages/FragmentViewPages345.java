 ...
 * Use the {@link FragmentViewPages345#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages345 extends Fragment {
    ...
    public static FragmentViewPages345 newInstance(String param1, String param2) {
        FragmentViewPages345 fragment = new FragmentViewPages345();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page345, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page345);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear345);
