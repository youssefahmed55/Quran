 ...
 * Use the {@link FragmentViewPages290#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages290 extends Fragment {
    ...
    public static FragmentViewPages290 newInstance(String param1, String param2) {
        FragmentViewPages290 fragment = new FragmentViewPages290();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page290, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page290);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear290);
