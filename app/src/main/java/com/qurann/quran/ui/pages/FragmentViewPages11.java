 ...
 * Use the {@link FragmentViewPages11#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages11 extends Fragment {
    ...
    public static FragmentViewPages11 newInstance(String param1, String param2) {
        FragmentViewPages11 fragment = new FragmentViewPages11();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page11, container, false);
        handleViews();
        return  viewGroup;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page11);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear11);
