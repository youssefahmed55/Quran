 ...
 * Use the {@link FragmentViewPages425#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages425 extends Fragment {
    ...
    public static FragmentViewPages425 newInstance(String param1, String param2) {
        FragmentViewPages425 fragment = new FragmentViewPages425();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page425, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page425);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear425);
