 ...
 * Use the {@link FragmentViewPages395#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages395 extends Fragment {
    ...
    public static FragmentViewPages395 newInstance(String param1, String param2) {
        FragmentViewPages395 fragment = new FragmentViewPages395();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page395, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page395);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear395);
