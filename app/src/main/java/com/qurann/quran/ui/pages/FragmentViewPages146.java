 ...
 * Use the {@link FragmentViewPages146#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages146 extends Fragment {
    ...
    public static FragmentViewPages146 newInstance(String param1, String param2) {
        FragmentViewPages146 fragment = new FragmentViewPages146();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page146, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page146);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear146);
