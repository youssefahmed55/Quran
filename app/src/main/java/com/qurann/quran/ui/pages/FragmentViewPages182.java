 ...
 * Use the {@link FragmentViewPages182#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages182 extends Fragment {
    ...
    public static FragmentViewPages182 newInstance(String param1, String param2) {
        FragmentViewPages182 fragment = new FragmentViewPages182();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page182, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page182);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear182);
