 ...
 * Use the {@link FragmentViewPages32#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages32 extends Fragment {
    ...
    public static FragmentViewPages32 newInstance(String param1, String param2) {
        FragmentViewPages32 fragment = new FragmentViewPages32();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page32, container, false);
        handleViews();
        return viewGroup;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page32);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear32);
