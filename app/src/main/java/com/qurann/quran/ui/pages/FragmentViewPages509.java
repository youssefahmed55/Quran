 ...
 * Use the {@link FragmentViewPages509#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages509 extends Fragment {
    ...
    public static FragmentViewPages509 newInstance(String param1, String param2) {
        FragmentViewPages509 fragment = new FragmentViewPages509();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page509, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page509);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear509);
