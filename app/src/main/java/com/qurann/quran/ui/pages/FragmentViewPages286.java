 ...
 * Use the {@link FragmentViewPages286#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages286 extends Fragment {
    ...
    public static FragmentViewPages286 newInstance(String param1, String param2) {
        FragmentViewPages286 fragment = new FragmentViewPages286();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page286, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page286);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear286);
