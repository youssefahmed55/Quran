 ...
 * Use the {@link FragmentViewPages70#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages70 extends Fragment {
    ...
    public static FragmentViewPages70 newInstance(String param1, String param2) {
        FragmentViewPages70 fragment = new FragmentViewPages70();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page70, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page70);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear70);
