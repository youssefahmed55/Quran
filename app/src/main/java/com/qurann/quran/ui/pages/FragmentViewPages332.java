 ...
 * Use the {@link FragmentViewPages332#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages332 extends Fragment {
    ...
    public static FragmentViewPages332 newInstance(String param1, String param2) {
        FragmentViewPages332 fragment = new FragmentViewPages332();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page332, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page332);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear332);
