 ...
 * Use the {@link FragmentViewPages8#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages8 extends Fragment {
    ...
    public static FragmentViewPages8 newInstance(String param1, String param2) {
        FragmentViewPages8 fragment = new FragmentViewPages8();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page8, container, false);
        handleViews();
        return  viewGroup;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page8);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear8);
