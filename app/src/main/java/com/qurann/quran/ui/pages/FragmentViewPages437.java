 ...
 * Use the {@link FragmentViewPages437#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages437 extends Fragment {
    ...
    public static FragmentViewPages437 newInstance(String param1, String param2) {
        FragmentViewPages437 fragment = new FragmentViewPages437();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page437, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page437);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear437);
