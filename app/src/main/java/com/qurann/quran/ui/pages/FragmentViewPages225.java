 ...
 * Use the {@link FragmentViewPages225#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages225 extends Fragment {
    ...
    public static FragmentViewPages225 newInstance(String param1, String param2) {
        FragmentViewPages225 fragment = new FragmentViewPages225();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page225, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page225);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear225);
