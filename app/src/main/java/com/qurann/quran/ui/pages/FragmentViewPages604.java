 ...
 * Use the {@link FragmentViewPages604#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages604 extends Fragment {
    ...
    public static FragmentViewPages604 newInstance(String param1, String param2) {
        FragmentViewPages604 fragment = new FragmentViewPages604();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page604, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear604);
        linearLayout2 = viewGroup.findViewById(R.id.linear604_2);
        linearLayout3 = viewGroup.findViewById(R.id.linear604_3);

        s = getActivity().getResources().getString(R.string.page604);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page604_2);
        views.clear();
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page604_3);
        views.clear();
