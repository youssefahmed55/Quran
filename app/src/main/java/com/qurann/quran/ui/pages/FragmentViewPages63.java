 ...
 * Use the {@link FragmentViewPages63#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages63 extends Fragment {
    ...
    public static FragmentViewPages63 newInstance(String param1, String param2) {
        FragmentViewPages63 fragment = new FragmentViewPages63();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page63, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page63);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear63);
