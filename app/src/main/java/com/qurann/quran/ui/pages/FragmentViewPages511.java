 ...
 * Use the {@link FragmentViewPages511#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages511 extends Fragment {
    ...
    public static FragmentViewPages511 newInstance(String param1, String param2) {
        FragmentViewPages511 fragment = new FragmentViewPages511();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page511, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page511);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear511);
