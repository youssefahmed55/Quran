 ...
 * Use the {@link FragmentViewPages366#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages366 extends Fragment {
    ...
    public static FragmentViewPages366 newInstance(String param1, String param2) {
        FragmentViewPages366 fragment = new FragmentViewPages366();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page366, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page366);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear366);
