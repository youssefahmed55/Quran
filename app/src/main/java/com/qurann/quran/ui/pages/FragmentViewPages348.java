 ...
 * Use the {@link FragmentViewPages348#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages348 extends Fragment {
    ...
    public static FragmentViewPages348 newInstance(String param1, String param2) {
        FragmentViewPages348 fragment = new FragmentViewPages348();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page348, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page348);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear348);
