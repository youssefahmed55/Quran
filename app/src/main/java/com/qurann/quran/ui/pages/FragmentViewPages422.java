 ...
 * Use the {@link FragmentViewPages422#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages422 extends Fragment {
    ...
    public static FragmentViewPages422 newInstance(String param1, String param2) {
        FragmentViewPages422 fragment = new FragmentViewPages422();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page422, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page422);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear422);
