 ...
 * Use the {@link FragmentViewPages122#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages122 extends Fragment {
    ...
    public static FragmentViewPages122 newInstance(String param1, String param2) {
        FragmentViewPages122 fragment = new FragmentViewPages122();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page122, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page122);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear122);
