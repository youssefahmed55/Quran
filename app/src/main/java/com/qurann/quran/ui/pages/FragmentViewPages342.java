 ...
 * Use the {@link FragmentViewPages342#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages342 extends Fragment {
    ...
    public static FragmentViewPages342 newInstance(String param1, String param2) {
        FragmentViewPages342 fragment = new FragmentViewPages342();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page342, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page342);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear342);
