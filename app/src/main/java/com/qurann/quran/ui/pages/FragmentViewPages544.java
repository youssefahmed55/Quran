 ...
 * Use the {@link FragmentViewPages544#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages544 extends Fragment {
    ...
    public static FragmentViewPages544 newInstance(String param1, String param2) {
        FragmentViewPages544 fragment = new FragmentViewPages544();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page544, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page544);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear544);
