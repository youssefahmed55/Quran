 ...
 * Use the {@link FragmentViewPages21#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages21 extends Fragment {
    ...
    public static FragmentViewPages21 newInstance(String param1, String param2) {
        FragmentViewPages21 fragment = new FragmentViewPages21();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page21, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page21);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear21);
