 ...
 * Use the {@link FragmentViewPages30#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages30 extends Fragment {
    ...
    public static FragmentViewPages30 newInstance(String param1, String param2) {
        FragmentViewPages30 fragment = new FragmentViewPages30();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page30, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page30);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear30);
