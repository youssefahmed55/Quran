 ...
 * Use the {@link FragmentViewPages53#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages53 extends Fragment {
    ...
    public static FragmentViewPages53 newInstance(String param1, String param2) {
        FragmentViewPages53 fragment = new FragmentViewPages53();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page53, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page53);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear53);
