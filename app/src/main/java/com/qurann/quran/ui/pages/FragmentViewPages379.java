 ...
 * Use the {@link FragmentViewPages379#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages379 extends Fragment {
    ...
    public static FragmentViewPages379 newInstance(String param1, String param2) {
        FragmentViewPages379 fragment = new FragmentViewPages379();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page379, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page379);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear379);
