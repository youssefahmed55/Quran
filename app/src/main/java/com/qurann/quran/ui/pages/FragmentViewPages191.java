 ...
 * Use the {@link FragmentViewPages191#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages191 extends Fragment {
    ...
    public static FragmentViewPages191 newInstance(String param1, String param2) {
        FragmentViewPages191 fragment = new FragmentViewPages191();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page191, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page191);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear191);
