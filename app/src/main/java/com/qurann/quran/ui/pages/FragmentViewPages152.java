 ...
 * Use the {@link FragmentViewPages152#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages152 extends Fragment {
    ...
    public static FragmentViewPages152 newInstance(String param1, String param2) {
        FragmentViewPages152 fragment = new FragmentViewPages152();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page152, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page152);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear152);
