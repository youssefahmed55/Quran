 ...
 * Use the {@link FragmentViewPages568#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages568 extends Fragment {
    ...
    public static FragmentViewPages568 newInstance(String param1, String param2) {
        FragmentViewPages568 fragment = new FragmentViewPages568();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page568, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear568);
        linearLayout2 = viewGroup.findViewById(R.id.linear568_2);
        s = getActivity().getResources().getString(R.string.page568);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page568_2);
        views.clear();
