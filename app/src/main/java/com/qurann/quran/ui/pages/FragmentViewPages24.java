 ...
 * Use the {@link FragmentViewPages24#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages24 extends Fragment {
    ...
    public static FragmentViewPages24 newInstance(String param1, String param2) {
        FragmentViewPages24 fragment = new FragmentViewPages24();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page24, container, false);
        handleViews();
        return viewGroup;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page24);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear24);
