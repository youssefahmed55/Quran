 ...
 * Use the {@link FragmentViewPages233#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages233 extends Fragment {
    ...
    public static FragmentViewPages233 newInstance(String param1, String param2) {
        FragmentViewPages233 fragment = new FragmentViewPages233();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page233, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page233);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear233);
