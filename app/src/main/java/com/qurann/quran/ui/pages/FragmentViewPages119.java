 ...
 * Use the {@link FragmentViewPages119#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages119 extends Fragment {
    ...
    public static FragmentViewPages119 newInstance(String param1, String param2) {
        FragmentViewPages119 fragment = new FragmentViewPages119();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page119, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page119);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear119);
