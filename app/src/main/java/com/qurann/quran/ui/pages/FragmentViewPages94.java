 ...
 * Use the {@link FragmentViewPages94#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages94 extends Fragment {
    ...
    public static FragmentViewPages94 newInstance(String param1, String param2) {
        FragmentViewPages94 fragment = new FragmentViewPages94();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page94, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page94);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear94);
