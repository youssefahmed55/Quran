 ...
 * Use the {@link FragmentViewPages408#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages408 extends Fragment {
    ...
    public static FragmentViewPages408 newInstance(String param1, String param2) {
        FragmentViewPages408 fragment = new FragmentViewPages408();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page408, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page408);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear408);
