 ...
 * Use the {@link FragmentViewPages5#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages5 extends Fragment {
    ...
    public static FragmentViewPages5 newInstance(String param1, String param2) {
        FragmentViewPages5 fragment = new FragmentViewPages5();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page5, container, false);
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page5);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear5);
