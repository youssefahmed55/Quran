 ...
 * Use the {@link FragmentViewPages124#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages124 extends Fragment {
    ...
    public static FragmentViewPages124 newInstance(String param1, String param2) {
        FragmentViewPages124 fragment = new FragmentViewPages124();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page124, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page124);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear124);
