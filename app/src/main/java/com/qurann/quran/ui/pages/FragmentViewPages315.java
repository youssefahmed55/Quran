 ...
 * Use the {@link FragmentViewPages315#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages315 extends Fragment {
    ...
    public static FragmentViewPages315 newInstance(String param1, String param2) {
        FragmentViewPages315 fragment = new FragmentViewPages315();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page315, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page315);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear315);
