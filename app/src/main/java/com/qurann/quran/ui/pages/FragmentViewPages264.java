 ...
 * Use the {@link FragmentViewPages264#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages264 extends Fragment {
    ...
    public static FragmentViewPages264 newInstance(String param1, String param2) {
        FragmentViewPages264 fragment = new FragmentViewPages264();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page264, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page264);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear264);
