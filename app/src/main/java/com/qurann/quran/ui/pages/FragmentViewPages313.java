 ...
 * Use the {@link FragmentViewPages313#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages313 extends Fragment {
    ...
    public static FragmentViewPages313 newInstance(String param1, String param2) {
        FragmentViewPages313 fragment = new FragmentViewPages313();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page313, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page313);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear313);
