 ...
 * Use the {@link FragmentViewPages247#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages247 extends Fragment {
    ...
    public static FragmentViewPages247 newInstance(String param1, String param2) {
        FragmentViewPages247 fragment = new FragmentViewPages247();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page247, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page247);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear247);
