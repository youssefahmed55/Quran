 ...
 * Use the {@link FragmentViewPages474#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages474 extends Fragment {
    ...
    public static FragmentViewPages474 newInstance(String param1, String param2) {
        FragmentViewPages474 fragment = new FragmentViewPages474();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page474, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page474);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear474);
