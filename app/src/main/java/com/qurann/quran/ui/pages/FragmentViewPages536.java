 ...
 * Use the {@link FragmentViewPages536#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages536 extends Fragment {
    ...
    public static FragmentViewPages536 newInstance(String param1, String param2) {
        FragmentViewPages536 fragment = new FragmentViewPages536();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page536, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page536);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear536);
