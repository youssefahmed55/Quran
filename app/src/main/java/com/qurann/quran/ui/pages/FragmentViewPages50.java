 ...
 * Use the {@link FragmentViewPages50#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages50 extends Fragment {
    ...
    public static FragmentViewPages50 newInstance(String param1, String param2) {
        FragmentViewPages50 fragment = new FragmentViewPages50();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page50, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page50);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear50);
