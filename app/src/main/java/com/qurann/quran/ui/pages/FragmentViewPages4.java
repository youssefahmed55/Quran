 ...
 * Use the {@link FragmentViewPages4#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages4 extends Fragment {
    ...
    public static FragmentViewPages4 newInstance(String param1, String param2) {
        FragmentViewPages4 fragment = new FragmentViewPages4();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page4, container, false);
        handleViews();
        return viewGroup;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page4);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear4);
