 ...
 * Use the {@link FragmentViewPages274#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages274 extends Fragment {
    ...
    public static FragmentViewPages274 newInstance(String param1, String param2) {
        FragmentViewPages274 fragment = new FragmentViewPages274();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page274, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page274);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear274);
