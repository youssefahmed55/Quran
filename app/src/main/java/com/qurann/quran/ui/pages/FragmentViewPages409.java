 ...
 * Use the {@link FragmentViewPages409#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages409 extends Fragment {
    ...
    public static FragmentViewPages409 newInstance(String param1, String param2) {
        FragmentViewPages409 fragment = new FragmentViewPages409();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page409, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page409);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear409);
