 ...
 * Use the {@link FragmentViewPages431#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages431 extends Fragment {
    ...
    public static FragmentViewPages431 newInstance(String param1, String param2) {
        FragmentViewPages431 fragment = new FragmentViewPages431();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page431, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page431);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear431);
