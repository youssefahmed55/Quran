 ...
 * Use the {@link FragmentViewPages497#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages497 extends Fragment {
    ...
    public static FragmentViewPages497 newInstance(String param1, String param2) {
        FragmentViewPages497 fragment = new FragmentViewPages497();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page497, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page497);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear497);
