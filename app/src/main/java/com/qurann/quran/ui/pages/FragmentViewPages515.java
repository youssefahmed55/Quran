 ...
 * Use the {@link FragmentViewPages515#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages515 extends Fragment {
    ...
    public static FragmentViewPages515 newInstance(String param1, String param2) {
        FragmentViewPages515 fragment = new FragmentViewPages515();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page515, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear515);
        linearLayout2 = viewGroup.findViewById(R.id.linear515_2);
        s = getActivity().getResources().getString(R.string.page515);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page515_2);
        views.clear();
