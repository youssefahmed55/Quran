 ...
 * Use the {@link FragmentViewPages132#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages132 extends Fragment {
    ...
    public static FragmentViewPages132 newInstance(String param1, String param2) {
        FragmentViewPages132 fragment = new FragmentViewPages132();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page132, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page132);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear132);
