 ...
 * Use the {@link FragmentViewPages178#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages178 extends Fragment {
    ...
    public static FragmentViewPages178 newInstance(String param1, String param2) {
        FragmentViewPages178 fragment = new FragmentViewPages178();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page178, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page178);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear178);
