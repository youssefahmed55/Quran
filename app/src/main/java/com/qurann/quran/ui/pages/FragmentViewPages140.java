 ...
 * Use the {@link FragmentViewPages140#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages140 extends Fragment {
    ...
    public static FragmentViewPages140 newInstance(String param1, String param2) {
        FragmentViewPages140 fragment = new FragmentViewPages140();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page140, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page140);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear140);
