 ...
 * Use the {@link FragmentViewPages95#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages95 extends Fragment {
    ...
    public static FragmentViewPages95 newInstance(String param1, String param2) {
        FragmentViewPages95 fragment = new FragmentViewPages95();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page95, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page95);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear95);
