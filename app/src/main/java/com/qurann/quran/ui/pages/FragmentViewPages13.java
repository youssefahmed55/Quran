 ...
 * Use the {@link FragmentViewPages13#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages13 extends Fragment {
    ...
    public static FragmentViewPages13 newInstance(String param1, String param2) {
        FragmentViewPages13 fragment = new FragmentViewPages13();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page13, container, false);
        handleViews();
        return  viewGroup;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page13);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear13);
