 ...
 * Use the {@link FragmentViewPages434#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages434 extends Fragment {
    ...
    public static FragmentViewPages434 newInstance(String param1, String param2) {
        FragmentViewPages434 fragment = new FragmentViewPages434();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page434, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear434);
        linearLayout2 = viewGroup.findViewById(R.id.linear434_2);
        s = getActivity().getResources().getString(R.string.page434);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page434_2);
        views.clear();
