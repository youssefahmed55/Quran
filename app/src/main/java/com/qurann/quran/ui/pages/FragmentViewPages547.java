 ...
 * Use the {@link FragmentViewPages547#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages547 extends Fragment {
    ...
    public static FragmentViewPages547 newInstance(String param1, String param2) {
        FragmentViewPages547 fragment = new FragmentViewPages547();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page547, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page547);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear547);
