 ...
 * Use the {@link FragmentViewPages135#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages135 extends Fragment {
    ...
    public static FragmentViewPages135 newInstance(String param1, String param2) {
        FragmentViewPages135 fragment = new FragmentViewPages135();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page135, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page135);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear135);
