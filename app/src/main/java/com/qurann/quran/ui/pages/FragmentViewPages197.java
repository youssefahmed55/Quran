 ...
 * Use the {@link FragmentViewPages197#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages197 extends Fragment {
    ...
    public static FragmentViewPages197 newInstance(String param1, String param2) {
        FragmentViewPages197 fragment = new FragmentViewPages197();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page197, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page197);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear197);
