 ...
 * Use the {@link FragmentViewPages591#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages591 extends Fragment {
    ...
    public static FragmentViewPages591 newInstance(String param1, String param2) {
        FragmentViewPages591 fragment = new FragmentViewPages591();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page591, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear591);
        linearLayout2 = viewGroup.findViewById(R.id.linear591_2);
        s = getActivity().getResources().getString(R.string.page591);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page591_2);
        views.clear();
