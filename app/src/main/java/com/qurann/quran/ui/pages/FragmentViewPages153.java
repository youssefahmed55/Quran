 ...
 * Use the {@link FragmentViewPages153#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages153 extends Fragment {
    ...
    public static FragmentViewPages153 newInstance(String param1, String param2) {
        FragmentViewPages153 fragment = new FragmentViewPages153();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page153, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page153);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear153);
