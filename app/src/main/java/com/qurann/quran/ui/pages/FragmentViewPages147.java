 ...
 * Use the {@link FragmentViewPages147#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages147 extends Fragment {
    ...
    public static FragmentViewPages147 newInstance(String param1, String param2) {
        FragmentViewPages147 fragment = new FragmentViewPages147();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page147, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page147);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear147);
