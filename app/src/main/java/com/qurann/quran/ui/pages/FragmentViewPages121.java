 ...
 * Use the {@link FragmentViewPages121#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages121 extends Fragment {
    ...
    public static FragmentViewPages121 newInstance(String param1, String param2) {
        FragmentViewPages121 fragment = new FragmentViewPages121();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page121, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page121);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear121);
