 ...
 * Use the {@link FragmentViewPages574#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages574 extends Fragment {
    ...
    public static FragmentViewPages574 newInstance(String param1, String param2) {
        FragmentViewPages574 fragment = new FragmentViewPages574();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page574, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page574);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear574);
