 ...
 * Use the {@link FragmentViewPages277#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages277 extends Fragment {
    ...
    public static FragmentViewPages277 newInstance(String param1, String param2) {
        FragmentViewPages277 fragment = new FragmentViewPages277();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page277, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page277);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear277);
