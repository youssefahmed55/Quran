 ...
 * Use the {@link FragmentViewPages129#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages129 extends Fragment {
    ...
    public static FragmentViewPages129 newInstance(String param1, String param2) {
        FragmentViewPages129 fragment = new FragmentViewPages129();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page129, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page129);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear129);
