 ...
 * Use the {@link FragmentViewPages216#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages216 extends Fragment {
    ...
    public static FragmentViewPages216 newInstance(String param1, String param2) {
        FragmentViewPages216 fragment = new FragmentViewPages216();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page216, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page216);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear216);
