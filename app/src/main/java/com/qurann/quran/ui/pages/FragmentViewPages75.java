 ...
 * Use the {@link FragmentViewPages75#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages75 extends Fragment {
    ...
    public static FragmentViewPages75 newInstance(String param1, String param2) {
        FragmentViewPages75 fragment = new FragmentViewPages75();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page75, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page75);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear75);
