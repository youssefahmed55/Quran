 ...
 * Use the {@link FragmentViewPages602#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages602 extends Fragment {
    ...
    public static FragmentViewPages602 newInstance(String param1, String param2) {
        FragmentViewPages602 fragment = new FragmentViewPages602();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page602, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear602);
        linearLayout2 = viewGroup.findViewById(R.id.linear602_2);
        linearLayout3 = viewGroup.findViewById(R.id.linear602_3);

        s = getActivity().getResources().getString(R.string.page602);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page602_2);
        views.clear();
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page602_3);
        views.clear();
