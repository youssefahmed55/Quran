 ...
 * Use the {@link FragmentViewPages171#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages171 extends Fragment {
    ...
    public static FragmentViewPages171 newInstance(String param1, String param2) {
        FragmentViewPages171 fragment = new FragmentViewPages171();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page171, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page171);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear171);
