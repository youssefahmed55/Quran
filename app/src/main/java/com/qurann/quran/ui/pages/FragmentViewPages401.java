 ...
 * Use the {@link FragmentViewPages401#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages401 extends Fragment {
    ...
    public static FragmentViewPages401 newInstance(String param1, String param2) {
        FragmentViewPages401 fragment = new FragmentViewPages401();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page401, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page401);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear401);
