 ...
 * Use the {@link FragmentViewPages260#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages260 extends Fragment {
    ...
    public static FragmentViewPages260 newInstance(String param1, String param2) {
        FragmentViewPages260 fragment = new FragmentViewPages260();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page260, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page260);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear260);
