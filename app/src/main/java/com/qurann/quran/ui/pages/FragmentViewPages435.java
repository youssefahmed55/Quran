 ...
 * Use the {@link FragmentViewPages435#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages435 extends Fragment {
    ...
    public static FragmentViewPages435 newInstance(String param1, String param2) {
        FragmentViewPages435 fragment = new FragmentViewPages435();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page435, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page435);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear435);
