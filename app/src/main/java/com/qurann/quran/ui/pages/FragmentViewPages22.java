 ...
 * Use the {@link FragmentViewPages22#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages22 extends Fragment {
    ...
    public static FragmentViewPages22 newInstance(String param1, String param2) {
        FragmentViewPages22 fragment = new FragmentViewPages22();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page22, container, false);
        handleViews();
        return viewGroup;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page22);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear22);
