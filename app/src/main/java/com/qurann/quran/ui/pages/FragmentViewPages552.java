 ...
 * Use the {@link FragmentViewPages552#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages552 extends Fragment {
    ...
    public static FragmentViewPages552 newInstance(String param1, String param2) {
        FragmentViewPages552 fragment = new FragmentViewPages552();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page552, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page552);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear552);
