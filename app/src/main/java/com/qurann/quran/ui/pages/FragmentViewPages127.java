 ...
 * Use the {@link FragmentViewPages127#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages127 extends Fragment {
    ...
    public static FragmentViewPages127 newInstance(String param1, String param2) {
        FragmentViewPages127 fragment = new FragmentViewPages127();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page127, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page127);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear127);
