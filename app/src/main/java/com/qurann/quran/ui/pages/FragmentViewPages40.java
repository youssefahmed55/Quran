 ...
 * Use the {@link FragmentViewPages40#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages40 extends Fragment {
    ...
    public static FragmentViewPages40 newInstance(String param1, String param2) {
        FragmentViewPages40 fragment = new FragmentViewPages40();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page40, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page40);
        ...
        for (String word : s.split(" ")){
            ...
            switch (i){
                case 54 :
                    ...
                    imageView.setImageResource(R.drawable.num246);
                    views.add(imageView);
                    break;
                case 97 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num247);
                    views.add(imageView);
                    break;
                case 127 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num248);
                    views.add(imageView);
                    break;
        ...
        linearLayout = viewGroup.findViewById(R.id.linear40);
