 ...
 * Use the {@link FragmentViewPages18#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages18 extends Fragment {
    ...
    public static FragmentViewPages18 newInstance(String param1, String param2) {
        FragmentViewPages18 fragment = new FragmentViewPages18();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page18, container, false);
        handleViews();
        return viewGroup;
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page18);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear18);
