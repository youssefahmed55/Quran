 ...
 * Use the {@link FragmentViewPages322#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages322 extends Fragment {
    ...
    public static FragmentViewPages322 newInstance(String param1, String param2) {
        FragmentViewPages322 fragment = new FragmentViewPages322();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page322, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page322);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear322);
