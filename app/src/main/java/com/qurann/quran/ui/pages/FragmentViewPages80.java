 ...
 * Use the {@link FragmentViewPages80#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages80 extends Fragment {
    ...
    public static FragmentViewPages80 newInstance(String param1, String param2) {
        FragmentViewPages80 fragment = new FragmentViewPages80();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page80, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page80);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear80);
