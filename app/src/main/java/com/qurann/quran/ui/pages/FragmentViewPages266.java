 ...
 * Use the {@link FragmentViewPages266#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages266 extends Fragment {
    ...
    public static FragmentViewPages266 newInstance(String param1, String param2) {
        FragmentViewPages266 fragment = new FragmentViewPages266();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page266, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page266);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear266);
