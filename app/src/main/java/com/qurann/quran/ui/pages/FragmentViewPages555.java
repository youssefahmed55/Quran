 ...
 * Use the {@link FragmentViewPages555#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages555 extends Fragment {
    ...
    public static FragmentViewPages555 newInstance(String param1, String param2) {
        FragmentViewPages555 fragment = new FragmentViewPages555();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page555, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page555);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear555);
