 ...
 * Use the {@link FragmentViewPages406#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages406 extends Fragment {
    ...
    public static FragmentViewPages406 newInstance(String param1, String param2) {
        FragmentViewPages406 fragment = new FragmentViewPages406();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page406, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page406);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear406);
