 ...
 * Use the {@link FragmentViewPages405#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages405 extends Fragment {
    ...
    public static FragmentViewPages405 newInstance(String param1, String param2) {
        FragmentViewPages405 fragment = new FragmentViewPages405();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page405, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page405);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear405);
