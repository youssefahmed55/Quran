 ...
 * Use the {@link FragmentViewPages250#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages250 extends Fragment {
    ...
    public static FragmentViewPages250 newInstance(String param1, String param2) {
        FragmentViewPages250 fragment = new FragmentViewPages250();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page250, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page250);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear250);
