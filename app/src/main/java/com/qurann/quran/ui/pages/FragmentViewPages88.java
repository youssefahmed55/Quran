 ...
 * Use the {@link FragmentViewPages88#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages88 extends Fragment {
    ...
    public static FragmentViewPages88 newInstance(String param1, String param2) {
        FragmentViewPages88 fragment = new FragmentViewPages88();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page88, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page88);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear88);
