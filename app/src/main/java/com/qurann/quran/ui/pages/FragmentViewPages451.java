 ...
 * Use the {@link FragmentViewPages451#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages451 extends Fragment {
    ...
    public static FragmentViewPages451 newInstance(String param1, String param2) {
        FragmentViewPages451 fragment = new FragmentViewPages451();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page451, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page451);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear451);
