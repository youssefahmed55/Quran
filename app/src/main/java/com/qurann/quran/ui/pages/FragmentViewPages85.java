 ...
 * Use the {@link FragmentViewPages85#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages85 extends Fragment {
    ...
    public static FragmentViewPages85 newInstance(String param1, String param2) {
        FragmentViewPages85 fragment = new FragmentViewPages85();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page85, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page85);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear85);
