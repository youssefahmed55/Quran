 ...
 * Use the {@link FragmentViewPages217#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages217 extends Fragment {
    ...
    public static FragmentViewPages217 newInstance(String param1, String param2) {
        FragmentViewPages217 fragment = new FragmentViewPages217();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page217, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page217);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear217);
