 ...
 * Use the {@link FragmentViewPages385#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages385 extends Fragment {
    ...
    public static FragmentViewPages385 newInstance(String param1, String param2) {
        FragmentViewPages385 fragment = new FragmentViewPages385();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page385, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear385);
        linearLayout2 = viewGroup.findViewById(R.id.linear385_2);
        s = getActivity().getResources().getString(R.string.page385);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page385_2);
        views.clear();
