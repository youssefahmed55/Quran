 ...
 * Use the {@link FragmentViewPages510#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages510 extends Fragment {
    ...
    public static FragmentViewPages510 newInstance(String param1, String param2) {
        FragmentViewPages510 fragment = new FragmentViewPages510();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page510, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page510);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear510);
