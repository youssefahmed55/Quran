 ...
 * Use the {@link FragmentViewPages100#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages100 extends Fragment {
    ...
    public static FragmentViewPages100 newInstance(String param1, String param2) {
        FragmentViewPages100 fragment = new FragmentViewPages100();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page100, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page100);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear100);
