 ...
 * Use the {@link FragmentViewPages596#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages596 extends Fragment {
    ...
    public static FragmentViewPages596 newInstance(String param1, String param2) {
        FragmentViewPages596 fragment = new FragmentViewPages596();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page596, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear596);
        linearLayout2 = viewGroup.findViewById(R.id.linear596_2);
        linearLayout3 = viewGroup.findViewById(R.id.linear596_3);

        s = getActivity().getResources().getString(R.string.page596);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page596_2);
        views.clear();
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page596_3);
        views.clear();
