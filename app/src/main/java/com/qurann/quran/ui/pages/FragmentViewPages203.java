 ...
 * Use the {@link FragmentViewPages203#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages203 extends Fragment {
    ...
    public static FragmentViewPages203 newInstance(String param1, String param2) {
        FragmentViewPages203 fragment = new FragmentViewPages203();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page203, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page203);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear203);
