 ...
 * Use the {@link FragmentViewPages254#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages254 extends Fragment {
    ...
    public static FragmentViewPages254 newInstance(String param1, String param2) {
        FragmentViewPages254 fragment = new FragmentViewPages254();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page254, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page254);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear254);
