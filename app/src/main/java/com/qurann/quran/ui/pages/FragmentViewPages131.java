 ...
 * Use the {@link FragmentViewPages131#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages131 extends Fragment {
    ...
    public static FragmentViewPages131 newInstance(String param1, String param2) {
        FragmentViewPages131 fragment = new FragmentViewPages131();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page131, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page131);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear131);
