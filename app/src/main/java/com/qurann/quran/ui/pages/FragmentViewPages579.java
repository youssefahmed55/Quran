 ...
 * Use the {@link FragmentViewPages579#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages579 extends Fragment {
    ...
    public static FragmentViewPages579 newInstance(String param1, String param2) {
        FragmentViewPages579 fragment = new FragmentViewPages579();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page579, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page579);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear579);
