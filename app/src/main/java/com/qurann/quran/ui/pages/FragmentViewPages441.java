 ...
 * Use the {@link FragmentViewPages441#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages441 extends Fragment {
    ...
    public static FragmentViewPages441 newInstance(String param1, String param2) {
        FragmentViewPages441 fragment = new FragmentViewPages441();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page441, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page441);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear441);
