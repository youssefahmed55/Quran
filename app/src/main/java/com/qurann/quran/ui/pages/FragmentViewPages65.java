 ...
 * Use the {@link FragmentViewPages65#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages65 extends Fragment {
    ...
    public static FragmentViewPages65 newInstance(String param1, String param2) {
        FragmentViewPages65 fragment = new FragmentViewPages65();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page65, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page65);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear65);
