 ...
 * Use the {@link FragmentViewPages232#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages232 extends Fragment {
    ...
    public static FragmentViewPages232 newInstance(String param1, String param2) {
        FragmentViewPages232 fragment = new FragmentViewPages232();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page232, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page232);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear232);
