 ...
 * Use the {@link FragmentViewPages548#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages548 extends Fragment {
    ...
    public static FragmentViewPages548 newInstance(String param1, String param2) {
        FragmentViewPages548 fragment = new FragmentViewPages548();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page548, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page548);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear548);
