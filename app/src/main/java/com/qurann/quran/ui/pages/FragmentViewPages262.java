 ...
 * Use the {@link FragmentViewPages262#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages262 extends Fragment {
    ...
    public static FragmentViewPages262 newInstance(String param1, String param2) {
        FragmentViewPages262 fragment = new FragmentViewPages262();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page262, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page262);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear262);
