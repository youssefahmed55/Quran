 ...
 * Use the {@link FragmentViewPages397#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages397 extends Fragment {
    ...
    public static FragmentViewPages397 newInstance(String param1, String param2) {
        FragmentViewPages397 fragment = new FragmentViewPages397();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page397, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page397);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear397);
