 ...
 * Use the {@link FragmentViewPages81#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages81 extends Fragment {
    ...
    public static FragmentViewPages81 newInstance(String param1, String param2) {
        FragmentViewPages81 fragment = new FragmentViewPages81();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page81, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page81);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear81);
