 ...
 * Use the {@link FragmentViewPages347#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages347 extends Fragment {
    ...
    public static FragmentViewPages347 newInstance(String param1, String param2) {
        FragmentViewPages347 fragment = new FragmentViewPages347();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page347, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page347);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear347);
