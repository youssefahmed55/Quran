 ...
 * Use the {@link FragmentViewPages456#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages456 extends Fragment {
    ...
    public static FragmentViewPages456 newInstance(String param1, String param2) {
        FragmentViewPages456 fragment = new FragmentViewPages456();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page456, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page456);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear456);
