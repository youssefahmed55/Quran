 ...
 * Use the {@link FragmentViewPages221#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages221 extends Fragment {
    ...
    public static FragmentViewPages221 newInstance(String param1, String param2) {
        FragmentViewPages221 fragment = new FragmentViewPages221();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page221, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear221);
        linearLayout2 = viewGroup.findViewById(R.id.linear221_2);
        s = getActivity().getResources().getString(R.string.page221);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page221_2);
        views.clear();
