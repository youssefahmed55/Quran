 ...
 * Use the {@link FragmentViewPages336#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages336 extends Fragment {
    ...
    public static FragmentViewPages336 newInstance(String param1, String param2) {
        FragmentViewPages336 fragment = new FragmentViewPages336();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page336, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page336);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear336);
