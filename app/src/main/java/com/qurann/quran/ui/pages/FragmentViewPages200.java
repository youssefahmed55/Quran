 ...
 * Use the {@link FragmentViewPages200#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages200 extends Fragment {
    ...
    public static FragmentViewPages200 newInstance(String param1, String param2) {
        FragmentViewPages200 fragment = new FragmentViewPages200();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page200, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page200);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear200);
