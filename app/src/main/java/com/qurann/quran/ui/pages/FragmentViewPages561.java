 ...
 * Use the {@link FragmentViewPages561#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages561 extends Fragment {
    ...
    public static FragmentViewPages561 newInstance(String param1, String param2) {
        FragmentViewPages561 fragment = new FragmentViewPages561();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page561, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page561);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear561);
