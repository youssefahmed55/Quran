 ...
 * Use the {@link FragmentViewPages533#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages533 extends Fragment {
    ...
    public static FragmentViewPages533 newInstance(String param1, String param2) {
        FragmentViewPages533 fragment = new FragmentViewPages533();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page533, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page533);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear533);
