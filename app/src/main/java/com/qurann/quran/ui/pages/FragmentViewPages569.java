 ...
 * Use the {@link FragmentViewPages569#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages569 extends Fragment {
    ...
    public static FragmentViewPages569 newInstance(String param1, String param2) {
        FragmentViewPages569 fragment = new FragmentViewPages569();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page569, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page569);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear569);
