 ...
 * Use the {@link FragmentViewPages43#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages43 extends Fragment {
    ...
    public static FragmentViewPages43 newInstance(String param1, String param2) {
        FragmentViewPages43 fragment = new FragmentViewPages43();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page43, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page43);
        ...
        for (String word : s.split(" ")){
            ...
            switch (i){
                case 24 :
                    ...
                    imageView.setImageResource(R.drawable.num257);
                    views.add(imageView);
                    break;
                case 67 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num258);
                    views.add(imageView);
                    break;
                case 134 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num259);
                    views.add(imageView);
                    break;
        ...
        linearLayout = viewGroup.findViewById(R.id.linear43);
