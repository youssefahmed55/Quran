 ...
 * Use the {@link FragmentViewPages235#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages235 extends Fragment {
    ...
    public static FragmentViewPages235 newInstance(String param1, String param2) {
        FragmentViewPages235 fragment = new FragmentViewPages235();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page235, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear235);
        linearLayout2 = viewGroup.findViewById(R.id.linear235_2);
        s = getActivity().getResources().getString(R.string.page235);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page235_2);
        views.clear();
