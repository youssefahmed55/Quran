 ...
 * Use the {@link FragmentViewPages360#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages360 extends Fragment {
    ...
    public static FragmentViewPages360 newInstance(String param1, String param2) {
        FragmentViewPages360 fragment = new FragmentViewPages360();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page360, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page360);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear360);
