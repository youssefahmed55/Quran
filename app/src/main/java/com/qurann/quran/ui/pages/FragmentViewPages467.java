 ...
 * Use the {@link FragmentViewPages467#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages467 extends Fragment {
    ...
    public static FragmentViewPages467 newInstance(String param1, String param2) {
        FragmentViewPages467 fragment = new FragmentViewPages467();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page467, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear467);
        linearLayout2 = viewGroup.findViewById(R.id.linear467_2);
        s = getActivity().getResources().getString(R.string.page467);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page467_2);
        views.clear();
