 ...
 * Use the {@link FragmentViewPages540#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages540 extends Fragment {
    ...
    public static FragmentViewPages540 newInstance(String param1, String param2) {
        FragmentViewPages540 fragment = new FragmentViewPages540();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page540, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page540);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear540);
