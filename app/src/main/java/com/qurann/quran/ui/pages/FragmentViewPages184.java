 ...
 * Use the {@link FragmentViewPages184#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages184 extends Fragment {
    ...
    public static FragmentViewPages184 newInstance(String param1, String param2) {
        FragmentViewPages184 fragment = new FragmentViewPages184();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page184, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page184);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear184);
