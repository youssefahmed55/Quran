 ...
 * Use the {@link FragmentViewPages301#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages301 extends Fragment {
    ...
    public static FragmentViewPages301 newInstance(String param1, String param2) {
        FragmentViewPages301 fragment = new FragmentViewPages301();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page301, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page301);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear301);
