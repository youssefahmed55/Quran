 ...
 * Use the {@link FragmentViewPages333#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages333 extends Fragment {
    ...
    public static FragmentViewPages333 newInstance(String param1, String param2) {
        FragmentViewPages333 fragment = new FragmentViewPages333();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page333, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page333);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear333);
