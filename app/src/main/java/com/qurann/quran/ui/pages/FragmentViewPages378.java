 ...
 * Use the {@link FragmentViewPages378#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages378 extends Fragment {
    ...
    public static FragmentViewPages378 newInstance(String param1, String param2) {
        FragmentViewPages378 fragment = new FragmentViewPages378();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page378, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page378);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear378);
