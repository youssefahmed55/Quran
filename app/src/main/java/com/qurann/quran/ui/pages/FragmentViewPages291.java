 ...
 * Use the {@link FragmentViewPages291#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages291 extends Fragment {
    ...
    public static FragmentViewPages291 newInstance(String param1, String param2) {
        FragmentViewPages291 fragment = new FragmentViewPages291();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page291, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page291);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear291);
