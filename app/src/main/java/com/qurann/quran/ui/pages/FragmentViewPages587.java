 ...
 * Use the {@link FragmentViewPages587#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages587 extends Fragment {
    ...
    public static FragmentViewPages587 newInstance(String param1, String param2) {
        FragmentViewPages587 fragment = new FragmentViewPages587();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page587, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear587);
        linearLayout2 = viewGroup.findViewById(R.id.linear587_2);
        s = getActivity().getResources().getString(R.string.page587);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page587_2);
        views.clear();
