 ...
 * Use the {@link FragmentViewPages211#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages211 extends Fragment {
    ...
    public static FragmentViewPages211 newInstance(String param1, String param2) {
        FragmentViewPages211 fragment = new FragmentViewPages211();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page211, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page211);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear211);
