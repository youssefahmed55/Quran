 ...
 * Use the {@link FragmentViewPages219#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages219 extends Fragment {
    ...
    public static FragmentViewPages219 newInstance(String param1, String param2) {
        FragmentViewPages219 fragment = new FragmentViewPages219();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page219, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page219);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear219);
