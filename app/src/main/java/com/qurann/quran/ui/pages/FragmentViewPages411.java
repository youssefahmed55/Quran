 ...
 * Use the {@link FragmentViewPages411#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages411 extends Fragment {
    ...
    public static FragmentViewPages411 newInstance(String param1, String param2) {
        FragmentViewPages411 fragment = new FragmentViewPages411();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page411, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page411);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear411);
