 ...
 * Use the {@link FragmentViewPages116#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages116 extends Fragment {
    ...
    public static FragmentViewPages116 newInstance(String param1, String param2) {
        FragmentViewPages116 fragment = new FragmentViewPages116();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page116, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page116);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear116);
