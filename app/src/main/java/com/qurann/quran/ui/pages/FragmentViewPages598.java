 ...
 * Use the {@link FragmentViewPages598#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages598 extends Fragment {
    ...
    public static FragmentViewPages598 newInstance(String param1, String param2) {
        FragmentViewPages598 fragment = new FragmentViewPages598();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page598, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear598);
        linearLayout2 = viewGroup.findViewById(R.id.linear598_2);
        s = getActivity().getResources().getString(R.string.page598);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page598_2);
        views.clear();
