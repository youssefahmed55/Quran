 ...
 * Use the {@link FragmentViewPages298#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages298 extends Fragment {
    ...
    public static FragmentViewPages298 newInstance(String param1, String param2) {
        FragmentViewPages298 fragment = new FragmentViewPages298();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page298, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page298);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear298);
