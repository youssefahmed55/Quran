 ...
 * Use the {@link FragmentViewPages384#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages384 extends Fragment {
    ...
    public static FragmentViewPages384 newInstance(String param1, String param2) {
        FragmentViewPages384 fragment = new FragmentViewPages384();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page384, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page384);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear384);
