 ...
 * Use the {@link FragmentViewPages249#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages249 extends Fragment {
    ...
    public static FragmentViewPages249 newInstance(String param1, String param2) {
        FragmentViewPages249 fragment = new FragmentViewPages249();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page249, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page249);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear249);
