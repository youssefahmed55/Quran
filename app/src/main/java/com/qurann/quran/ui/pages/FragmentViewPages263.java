 ...
 * Use the {@link FragmentViewPages263#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages263 extends Fragment {
    ...
    public static FragmentViewPages263 newInstance(String param1, String param2) {
        FragmentViewPages263 fragment = new FragmentViewPages263();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page263, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page263);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear263);
