 ...
 * Use the {@link FragmentViewPages271#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages271 extends Fragment {
    ...
    public static FragmentViewPages271 newInstance(String param1, String param2) {
        FragmentViewPages271 fragment = new FragmentViewPages271();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page271, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page271);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear271);
