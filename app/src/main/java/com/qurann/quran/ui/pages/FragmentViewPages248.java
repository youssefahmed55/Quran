 ...
 * Use the {@link FragmentViewPages248#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages248 extends Fragment {
    ...
    public static FragmentViewPages248 newInstance(String param1, String param2) {
        FragmentViewPages248 fragment = new FragmentViewPages248();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page248, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page248);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear248);
