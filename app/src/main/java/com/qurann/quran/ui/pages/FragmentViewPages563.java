 ...
 * Use the {@link FragmentViewPages563#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages563 extends Fragment {
    ...
    public static FragmentViewPages563 newInstance(String param1, String param2) {
        FragmentViewPages563 fragment = new FragmentViewPages563();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page563, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page563);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear563);
