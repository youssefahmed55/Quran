 ...
 * Use the {@link FragmentViewPages118#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages118 extends Fragment {
    ...
    public static FragmentViewPages118 newInstance(String param1, String param2) {
        FragmentViewPages118 fragment = new FragmentViewPages118();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page118, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page118);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear118);
