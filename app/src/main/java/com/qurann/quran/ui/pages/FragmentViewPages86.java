 ...
 * Use the {@link FragmentViewPages86#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages86 extends Fragment {
    ...
    public static FragmentViewPages86 newInstance(String param1, String param2) {
        FragmentViewPages86 fragment = new FragmentViewPages86();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page86, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page86);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear86);
