 ...
 * Use the {@link FragmentViewPages3#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages3 extends Fragment {
    ...
    public static FragmentViewPages3 newInstance(String param1, String param2) {
        FragmentViewPages3 fragment = new FragmentViewPages3();
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page3);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear3);
