 ...
 * Use the {@link FragmentViewPages48#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages48 extends Fragment {
    ...
    public static FragmentViewPages48 newInstance(String param1, String param2) {
        FragmentViewPages48 fragment = new FragmentViewPages48();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page48, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page48);
        ...
        for (String word : s.split(" ")){
            ...
            switch (i){
                case 129 :
                    ...
                    imageView.setImageResource(R.drawable.num282);
                    views.add(imageView);
                    break;
        ...
        linearLayout = viewGroup.findViewById(R.id.linear48);
