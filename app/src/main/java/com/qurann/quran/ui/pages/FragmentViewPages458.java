 ...
 * Use the {@link FragmentViewPages458#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages458 extends Fragment {
    ...
    public static FragmentViewPages458 newInstance(String param1, String param2) {
        FragmentViewPages458 fragment = new FragmentViewPages458();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page458, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear458);
        linearLayout2 = viewGroup.findViewById(R.id.linear458_2);
        s = getActivity().getResources().getString(R.string.page458);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page458_2);
        views.clear();
