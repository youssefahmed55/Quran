 ...
 * Use the {@link FragmentViewPages44#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages44 extends Fragment {
    ...
    public static FragmentViewPages44 newInstance(String param1, String param2) {
        FragmentViewPages44 fragment = new FragmentViewPages44();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page44, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page44);
        ...
        for (String word : s.split(" ")){
            ...
            switch (i){
                case 39 :
                    ...
                    imageView.setImageResource(R.drawable.num260);
                    views.add(imageView);
                    break;
                case 63 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num261);
                    views.add(imageView);
                    break;
                case 87 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num262);
                    views.add(imageView);
                    imageView = new ImageView(getActivity());
                ...
                case 98 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num263);
                    views.add(imageView);
                    break;
                case 137 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num264);
                    views.add(imageView);
                    break;
        ...
        linearLayout = viewGroup.findViewById(R.id.linear44);
