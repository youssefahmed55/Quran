 ...
 * Use the {@link FragmentViewPages159#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages159 extends Fragment {
    ...
    public static FragmentViewPages159 newInstance(String param1, String param2) {
        FragmentViewPages159 fragment = new FragmentViewPages159();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page159, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page159);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear159);
