 ...
 * Use the {@link FragmentViewPages27#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages27 extends Fragment {
    ...
    public static FragmentViewPages27 newInstance(String param1, String param2) {
        FragmentViewPages27 fragment = new FragmentViewPages27();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page27, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page27);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear27);
