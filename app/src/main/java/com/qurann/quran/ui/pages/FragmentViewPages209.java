 ...
 * Use the {@link FragmentViewPages209#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages209 extends Fragment {
    ...
    public static FragmentViewPages209 newInstance(String param1, String param2) {
        FragmentViewPages209 fragment = new FragmentViewPages209();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page209, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page209);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear209);
