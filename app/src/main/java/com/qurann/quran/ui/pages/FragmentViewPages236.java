 ...
 * Use the {@link FragmentViewPages236#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages236 extends Fragment {
    ...
    public static FragmentViewPages236 newInstance(String param1, String param2) {
        FragmentViewPages236 fragment = new FragmentViewPages236();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page236, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page236);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear236);
