 ...
 * Use the {@link FragmentViewPages192#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages192 extends Fragment {
    ...
    public static FragmentViewPages192 newInstance(String param1, String param2) {
        FragmentViewPages192 fragment = new FragmentViewPages192();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page192, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page192);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear192);
