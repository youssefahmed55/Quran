 ...
 * Use the {@link FragmentViewPages539#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages539 extends Fragment {
    ...
    public static FragmentViewPages539 newInstance(String param1, String param2) {
        FragmentViewPages539 fragment = new FragmentViewPages539();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page539, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page539);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear539);
