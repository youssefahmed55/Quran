 ...
 * Use the {@link FragmentViewPages35#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages35 extends Fragment {
    ...
    public static FragmentViewPages35 newInstance(String param1, String param2) {
        FragmentViewPages35 fragment = new FragmentViewPages35();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page35, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page35);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear35);
