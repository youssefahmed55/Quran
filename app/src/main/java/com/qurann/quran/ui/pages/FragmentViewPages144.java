 ...
 * Use the {@link FragmentViewPages144#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages144 extends Fragment {
    ...
    public static FragmentViewPages144 newInstance(String param1, String param2) {
        FragmentViewPages144 fragment = new FragmentViewPages144();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page144, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page144);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear144);
