 ...
 * Use the {@link FragmentViewPages39#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages39 extends Fragment {
    ...
    public static FragmentViewPages39 newInstance(String param1, String param2) {
        FragmentViewPages39 fragment = new FragmentViewPages39();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page39, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page39);
        ...
        for (String word : s.split(" ")){
            ...
            switch (i){
                case 8 :
                    ...
                    imageView.setImageResource(R.drawable.num238);
                    views.add(imageView);
                    break;
                case 23 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num239);
                    views.add(imageView);
                    break;
                case 50 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num240);
                    views.add(imageView);
                    break;
                case 56 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num241);
                    views.add(imageView);
                    break;
                case 63 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num242);
                    views.add(imageView);
                    imageView = new ImageView(getActivity());
                ...
                case 91 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num243);
                    views.add(imageView);
                    break;
                case 100 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num244);
                    views.add(imageView);
                    break;
                case 116 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num245);
                    views.add(imageView);
                    break;
            }
        ...
        linearLayout = viewGroup.findViewById(R.id.linear39);
