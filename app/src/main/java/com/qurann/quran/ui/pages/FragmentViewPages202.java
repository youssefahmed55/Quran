 ...
 * Use the {@link FragmentViewPages202#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages202 extends Fragment {
    ...
    public static FragmentViewPages202 newInstance(String param1, String param2) {
        FragmentViewPages202 fragment = new FragmentViewPages202();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page202, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page202);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear202);
