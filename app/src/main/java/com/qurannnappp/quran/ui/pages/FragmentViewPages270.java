 ...
 * Use the {@link FragmentViewPages270#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages270 extends Fragment {
    ...
    public static FragmentViewPages270 newInstance(String param1, String param2) {
        FragmentViewPages270 fragment = new FragmentViewPages270();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page270, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page270);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear270);
