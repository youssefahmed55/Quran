 ...
 * Use the {@link FragmentViewPages482#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages482 extends Fragment {
    ...
    public static FragmentViewPages482 newInstance(String param1, String param2) {
        FragmentViewPages482 fragment = new FragmentViewPages482();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page482, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page482);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear482);
