 ...
 * Use the {@link FragmentViewPages529#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages529 extends Fragment {
    ...
    public static FragmentViewPages529 newInstance(String param1, String param2) {
        FragmentViewPages529 fragment = new FragmentViewPages529();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page529, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page529);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear529);
