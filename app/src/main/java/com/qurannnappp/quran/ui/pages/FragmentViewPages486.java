 ...
 * Use the {@link FragmentViewPages486#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages486 extends Fragment {
    ...
    public static FragmentViewPages486 newInstance(String param1, String param2) {
        FragmentViewPages486 fragment = new FragmentViewPages486();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page486, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page486);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear486);
