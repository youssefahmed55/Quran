 ...
 * Use the {@link FragmentViewPages276#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages276 extends Fragment {
    ...
    public static FragmentViewPages276 newInstance(String param1, String param2) {
        FragmentViewPages276 fragment = new FragmentViewPages276();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page276, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page276);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear276);
