 ...
 * Use the {@link FragmentViewPages576#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages576 extends Fragment {
    ...
    public static FragmentViewPages576 newInstance(String param1, String param2) {
        FragmentViewPages576 fragment = new FragmentViewPages576();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page576, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page576);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear576);
