 ...
 * Use the {@link FragmentViewPages480#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages480 extends Fragment {
    ...
    public static FragmentViewPages480 newInstance(String param1, String param2) {
        FragmentViewPages480 fragment = new FragmentViewPages480();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page480, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page480);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear480);
