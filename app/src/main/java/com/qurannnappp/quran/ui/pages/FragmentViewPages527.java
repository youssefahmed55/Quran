 ...
 * Use the {@link FragmentViewPages527#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages527 extends Fragment {
    ...
    public static FragmentViewPages527 newInstance(String param1, String param2) {
        FragmentViewPages527 fragment = new FragmentViewPages527();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page527, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page527);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear527);
