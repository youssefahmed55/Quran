 ...
 * Use the {@link FragmentViewPages324#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages324 extends Fragment {
    ...
    public static FragmentViewPages324 newInstance(String param1, String param2) {
        FragmentViewPages324 fragment = new FragmentViewPages324();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page324, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page324);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear324);
