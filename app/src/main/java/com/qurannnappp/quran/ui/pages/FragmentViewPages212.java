 ...
 * Use the {@link FragmentViewPages212#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages212 extends Fragment {
    ...
    public static FragmentViewPages212 newInstance(String param1, String param2) {
        FragmentViewPages212 fragment = new FragmentViewPages212();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page212, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page212);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear212);
