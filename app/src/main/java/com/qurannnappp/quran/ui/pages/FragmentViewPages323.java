 ...
 * Use the {@link FragmentViewPages323#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages323 extends Fragment {
    ...
    public static FragmentViewPages323 newInstance(String param1, String param2) {
        FragmentViewPages323 fragment = new FragmentViewPages323();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page323, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page323);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear323);
