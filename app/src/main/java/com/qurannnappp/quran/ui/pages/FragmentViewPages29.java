 ...
 * Use the {@link FragmentViewPages29#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages29 extends Fragment {
    ...
    public static FragmentViewPages29 newInstance(String param1, String param2) {
        FragmentViewPages29 fragment = new FragmentViewPages29();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page29, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page29);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear29);
