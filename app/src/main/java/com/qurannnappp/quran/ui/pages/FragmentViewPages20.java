 ...
 * Use the {@link FragmentViewPages20#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages20 extends Fragment {
    ...
    public static FragmentViewPages20 newInstance(String param1, String param2) {
        FragmentViewPages20 fragment = new FragmentViewPages20();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page20, container, false);
        handleViews();
        return  viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page20);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear20);
