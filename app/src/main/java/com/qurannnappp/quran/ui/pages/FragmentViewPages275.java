 ...
 * Use the {@link FragmentViewPages275#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages275 extends Fragment {
    ...
    public static FragmentViewPages275 newInstance(String param1, String param2) {
        FragmentViewPages275 fragment = new FragmentViewPages275();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page275, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page275);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear275);
