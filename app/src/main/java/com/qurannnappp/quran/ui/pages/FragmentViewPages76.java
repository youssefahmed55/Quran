 ...
 * Use the {@link FragmentViewPages76#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages76 extends Fragment {
    ...
    public static FragmentViewPages76 newInstance(String param1, String param2) {
        FragmentViewPages76 fragment = new FragmentViewPages76();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page76, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page76);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear76);
