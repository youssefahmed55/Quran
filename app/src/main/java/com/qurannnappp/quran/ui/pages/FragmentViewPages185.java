 ...
 * Use the {@link FragmentViewPages185#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages185 extends Fragment {
    ...
    public static FragmentViewPages185 newInstance(String param1, String param2) {
        FragmentViewPages185 fragment = new FragmentViewPages185();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page185, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page185);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear185);
