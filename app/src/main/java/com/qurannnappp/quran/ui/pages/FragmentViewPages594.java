 ...
 * Use the {@link FragmentViewPages594#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages594 extends Fragment {
    ...
    public static FragmentViewPages594 newInstance(String param1, String param2) {
        FragmentViewPages594 fragment = new FragmentViewPages594();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page594, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear594);
        linearLayout2 = viewGroup.findViewById(R.id.linear594_2);
        s = getActivity().getResources().getString(R.string.page594);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page594_2);
        views.clear();
