 ...
 * Use the {@link FragmentViewPages554#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages554 extends Fragment {
    ...
    public static FragmentViewPages554 newInstance(String param1, String param2) {
        FragmentViewPages554 fragment = new FragmentViewPages554();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page554, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear554);
        linearLayout2 = viewGroup.findViewById(R.id.linear554_2);
        s = getActivity().getResources().getString(R.string.page554);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page554_2);
        views.clear();
