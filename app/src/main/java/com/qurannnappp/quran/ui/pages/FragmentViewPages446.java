 ...
 * Use the {@link FragmentViewPages446#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages446 extends Fragment {
    ...
    public static FragmentViewPages446 newInstance(String param1, String param2) {
        FragmentViewPages446 fragment = new FragmentViewPages446();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page446, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page446);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear446);
