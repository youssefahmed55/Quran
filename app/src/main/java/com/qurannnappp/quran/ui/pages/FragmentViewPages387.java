 ...
 * Use the {@link FragmentViewPages387#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages387 extends Fragment {
    ...
    public static FragmentViewPages387 newInstance(String param1, String param2) {
        FragmentViewPages387 fragment = new FragmentViewPages387();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page387, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page387);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear387);
