 ...
 * Use the {@link FragmentViewPages224#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages224 extends Fragment {
    ...
    public static FragmentViewPages224 newInstance(String param1, String param2) {
        FragmentViewPages224 fragment = new FragmentViewPages224();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page224, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page224);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear224);
