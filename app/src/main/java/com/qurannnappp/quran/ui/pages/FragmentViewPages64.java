 ...
 * Use the {@link FragmentViewPages64#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages64 extends Fragment {
    ...
    public static FragmentViewPages64 newInstance(String param1, String param2) {
        FragmentViewPages64 fragment = new FragmentViewPages64();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page64, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page64);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear64);
