 ...
 * Use the {@link FragmentViewPages68#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages68 extends Fragment {
    ...
    public static FragmentViewPages68 newInstance(String param1, String param2) {
        FragmentViewPages68 fragment = new FragmentViewPages68();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page68, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page68);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear68);
