 ...
 * Use the {@link FragmentViewPages518#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages518 extends Fragment {
    ...
    public static FragmentViewPages518 newInstance(String param1, String param2) {
        FragmentViewPages518 fragment = new FragmentViewPages518();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page518, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page518);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear518);
