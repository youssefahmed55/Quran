 ...
 * Use the {@link FragmentViewPages288#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages288 extends Fragment {
    ...
    public static FragmentViewPages288 newInstance(String param1, String param2) {
        FragmentViewPages288 fragment = new FragmentViewPages288();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page288, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page288);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear288);
