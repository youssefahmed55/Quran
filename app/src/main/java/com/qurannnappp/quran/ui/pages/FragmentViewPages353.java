 ...
 * Use the {@link FragmentViewPages353#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages353 extends Fragment {
    ...
    public static FragmentViewPages353 newInstance(String param1, String param2) {
        FragmentViewPages353 fragment = new FragmentViewPages353();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page353, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page353);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear353);
