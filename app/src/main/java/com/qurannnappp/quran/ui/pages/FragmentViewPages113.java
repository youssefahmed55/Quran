 ...
 * Use the {@link FragmentViewPages113#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages113 extends Fragment {
    ...
    public static FragmentViewPages113 newInstance(String param1, String param2) {
        FragmentViewPages113 fragment = new FragmentViewPages113();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page113, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page113);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear113);
