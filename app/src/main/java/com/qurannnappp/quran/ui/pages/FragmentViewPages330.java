 ...
 * Use the {@link FragmentViewPages330#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages330 extends Fragment {
    ...
    public static FragmentViewPages330 newInstance(String param1, String param2) {
        FragmentViewPages330 fragment = new FragmentViewPages330();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page330, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page330);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear330);
