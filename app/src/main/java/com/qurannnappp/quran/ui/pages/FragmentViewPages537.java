 ...
 * Use the {@link FragmentViewPages537#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages537 extends Fragment {
    ...
    public static FragmentViewPages537 newInstance(String param1, String param2) {
        FragmentViewPages537 fragment = new FragmentViewPages537();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page537, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear537);
        linearLayout2 = viewGroup.findViewById(R.id.linear537_2);
        s = getActivity().getResources().getString(R.string.page537);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page537_2);
        views.clear();
