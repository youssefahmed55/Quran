 ...
 * Use the {@link FragmentViewPages546#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages546 extends Fragment {
    ...
    public static FragmentViewPages546 newInstance(String param1, String param2) {
        FragmentViewPages546 fragment = new FragmentViewPages546();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page546, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page546);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear546);
