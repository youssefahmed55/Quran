 ...
 * Use the {@link FragmentViewPages210#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages210 extends Fragment {
    ...
    public static FragmentViewPages210 newInstance(String param1, String param2) {
        FragmentViewPages210 fragment = new FragmentViewPages210();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page210, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page210);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear210);
