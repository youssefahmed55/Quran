 ...
 * Use the {@link FragmentViewPages143#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages143 extends Fragment {
    ...
    public static FragmentViewPages143 newInstance(String param1, String param2) {
        FragmentViewPages143 fragment = new FragmentViewPages143();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page143, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page143);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear143);
