 ...
 * Use the {@link FragmentViewPages460#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages460 extends Fragment {
    ...
    public static FragmentViewPages460 newInstance(String param1, String param2) {
        FragmentViewPages460 fragment = new FragmentViewPages460();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page460, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page460);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear460);
