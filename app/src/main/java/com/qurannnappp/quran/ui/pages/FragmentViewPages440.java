 ...
 * Use the {@link FragmentViewPages440#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages440 extends Fragment {
    ...
    public static FragmentViewPages440 newInstance(String param1, String param2) {
        FragmentViewPages440 fragment = new FragmentViewPages440();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page440, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear440);
        linearLayout2 = viewGroup.findViewById(R.id.linear440_2);
        s = getActivity().getResources().getString(R.string.page440);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page440_2);
        views.clear();
