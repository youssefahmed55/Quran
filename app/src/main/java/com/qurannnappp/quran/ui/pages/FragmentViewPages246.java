 ...
 * Use the {@link FragmentViewPages246#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages246 extends Fragment {
    ...
    public static FragmentViewPages246 newInstance(String param1, String param2) {
        FragmentViewPages246 fragment = new FragmentViewPages246();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page246, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page246);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear246);
