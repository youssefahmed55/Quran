 ...
 * Use the {@link FragmentViewPages126#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages126 extends Fragment {
    ...
    public static FragmentViewPages126 newInstance(String param1, String param2) {
        FragmentViewPages126 fragment = new FragmentViewPages126();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page126, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page126);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear126);
