 ...
 * Use the {@link FragmentViewPages357#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages357 extends Fragment {
    ...
    public static FragmentViewPages357 newInstance(String param1, String param2) {
        FragmentViewPages357 fragment = new FragmentViewPages357();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page357, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page357);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear357);
