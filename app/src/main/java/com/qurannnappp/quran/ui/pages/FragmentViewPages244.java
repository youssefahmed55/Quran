 ...
 * Use the {@link FragmentViewPages244#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages244 extends Fragment {
    ...
    public static FragmentViewPages244 newInstance(String param1, String param2) {
        FragmentViewPages244 fragment = new FragmentViewPages244();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page244, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page244);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear244);
