 ...
 * Use the {@link FragmentViewPages308#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages308 extends Fragment {
    ...
    public static FragmentViewPages308 newInstance(String param1, String param2) {
        FragmentViewPages308 fragment = new FragmentViewPages308();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page308, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page308);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear308);
