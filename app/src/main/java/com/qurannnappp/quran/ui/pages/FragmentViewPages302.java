 ...
 * Use the {@link FragmentViewPages302#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages302 extends Fragment {
    ...
    public static FragmentViewPages302 newInstance(String param1, String param2) {
        FragmentViewPages302 fragment = new FragmentViewPages302();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page302, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page302);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear302);
