 ...
 * Use the {@link FragmentViewPages390#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages390 extends Fragment {
    ...
    public static FragmentViewPages390 newInstance(String param1, String param2) {
        FragmentViewPages390 fragment = new FragmentViewPages390();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page390, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page390);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear390);
