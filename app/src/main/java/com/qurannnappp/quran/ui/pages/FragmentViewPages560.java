 ...
 * Use the {@link FragmentViewPages560#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages560 extends Fragment {
    ...
    public static FragmentViewPages560 newInstance(String param1, String param2) {
        FragmentViewPages560 fragment = new FragmentViewPages560();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page560, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page560);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear560);
