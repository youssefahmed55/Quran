 ...
 * Use the {@link FragmentViewPages145#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages145 extends Fragment {
    ...
    public static FragmentViewPages145 newInstance(String param1, String param2) {
        FragmentViewPages145 fragment = new FragmentViewPages145();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page145, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page145);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear145);
