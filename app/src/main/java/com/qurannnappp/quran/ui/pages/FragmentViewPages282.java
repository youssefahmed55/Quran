 ...
 * Use the {@link FragmentViewPages282#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages282 extends Fragment {
    ...
    public static FragmentViewPages282 newInstance(String param1, String param2) {
        FragmentViewPages282 fragment = new FragmentViewPages282();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page282, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page282);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear282);
