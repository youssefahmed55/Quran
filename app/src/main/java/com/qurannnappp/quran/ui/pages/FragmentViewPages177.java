 ...
 * Use the {@link FragmentViewPages177#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages177 extends Fragment {
    ...
    public static FragmentViewPages177 newInstance(String param1, String param2) {
        FragmentViewPages177 fragment = new FragmentViewPages177();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page177, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page177);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear177);
