 ...
 * Use the {@link FragmentViewPages303#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages303 extends Fragment {
    ...
    public static FragmentViewPages303 newInstance(String param1, String param2) {
        FragmentViewPages303 fragment = new FragmentViewPages303();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page303, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page303);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear303);
