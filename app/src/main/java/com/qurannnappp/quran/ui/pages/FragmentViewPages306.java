 ...
 * Use the {@link FragmentViewPages306#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages306 extends Fragment {
    ...
    public static FragmentViewPages306 newInstance(String param1, String param2) {
        FragmentViewPages306 fragment = new FragmentViewPages306();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page306, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page306);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear306);
