 ...
 * Use the {@link FragmentViewPages603#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages603 extends Fragment {
    ...
    public static FragmentViewPages603 newInstance(String param1, String param2) {
        FragmentViewPages603 fragment = new FragmentViewPages603();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page603, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear603);
        linearLayout2 = viewGroup.findViewById(R.id.linear603_2);
        linearLayout3 = viewGroup.findViewById(R.id.linear603_3);

        s = getActivity().getResources().getString(R.string.page603);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page603_2);
        views.clear();
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page603_3);
        views.clear();
