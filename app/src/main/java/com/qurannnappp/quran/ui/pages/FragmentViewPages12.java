 ...
 * Use the {@link FragmentViewPages12#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages12 extends Fragment {
    ...
    public static FragmentViewPages12 newInstance(String param1, String param2) {
        FragmentViewPages12 fragment = new FragmentViewPages12();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page12, container, false);
        handleViews();
        return  viewGroup;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page12);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear12);
