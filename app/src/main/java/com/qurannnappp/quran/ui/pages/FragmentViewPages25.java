 ...
 * Use the {@link FragmentViewPages25#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages25 extends Fragment {
    ...
    public static FragmentViewPages25 newInstance(String param1, String param2) {
        FragmentViewPages25 fragment = new FragmentViewPages25();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page25, container, false);
        handleViews();
        return viewGroup;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page25);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear25);
