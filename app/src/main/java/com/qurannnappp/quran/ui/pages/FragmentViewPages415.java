 ...
 * Use the {@link FragmentViewPages415#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages415 extends Fragment {
    ...
    public static FragmentViewPages415 newInstance(String param1, String param2) {
        FragmentViewPages415 fragment = new FragmentViewPages415();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page415, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page415);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear415);
