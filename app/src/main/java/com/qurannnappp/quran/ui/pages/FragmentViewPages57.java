 ...
 * Use the {@link FragmentViewPages57#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages57 extends Fragment {
    ...
    public static FragmentViewPages57 newInstance(String param1, String param2) {
        FragmentViewPages57 fragment = new FragmentViewPages57();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page57, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page57);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear57);
