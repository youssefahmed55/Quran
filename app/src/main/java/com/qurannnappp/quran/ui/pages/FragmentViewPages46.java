 ...
 * Use the {@link FragmentViewPages46#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages46 extends Fragment {
    ...
    public static FragmentViewPages46 newInstance(String param1, String param2) {
        FragmentViewPages46 fragment = new FragmentViewPages46();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page46, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page46);
        ...
        for (String word : s.split(" ")){
            ...
            switch (i){
                case 15 :
                    ...
                    imageView.setImageResource(R.drawable.num270);
                    views.add(imageView);
                    break;
                case 35 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num271);
                    views.add(imageView);
                    imageView = new ImageView(getActivity());
                ...
                case 63 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num272);
                    views.add(imageView);
                    break;
                case 93 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num273);
                    views.add(imageView);
                    break;
                case 110 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num274);
                    views.add(imageView);
                    break;
        ...
        linearLayout = viewGroup.findViewById(R.id.linear46);
