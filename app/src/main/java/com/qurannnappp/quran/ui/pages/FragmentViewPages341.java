 ...
 * Use the {@link FragmentViewPages341#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages341 extends Fragment {
    ...
    public static FragmentViewPages341 newInstance(String param1, String param2) {
        FragmentViewPages341 fragment = new FragmentViewPages341();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page341, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page341);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear341);
