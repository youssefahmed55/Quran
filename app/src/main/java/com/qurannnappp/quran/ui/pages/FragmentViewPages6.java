 ...
 * Use the {@link FragmentViewPages6#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages6 extends Fragment {
    ...
    public static FragmentViewPages6 newInstance(String param1, String param2) {
        FragmentViewPages6 fragment = new FragmentViewPages6();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page6, container, false);
        handleViews();
        return viewGroup;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page6);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear6);
