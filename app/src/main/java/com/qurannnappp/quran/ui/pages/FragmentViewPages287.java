 ...
 * Use the {@link FragmentViewPages287#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages287 extends Fragment {
    ...
    public static FragmentViewPages287 newInstance(String param1, String param2) {
        FragmentViewPages287 fragment = new FragmentViewPages287();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page287, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page287);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear287);
