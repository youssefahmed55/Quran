 ...
 * Use the {@link FragmentViewPages449#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages449 extends Fragment {
    ...
    public static FragmentViewPages449 newInstance(String param1, String param2) {
        FragmentViewPages449 fragment = new FragmentViewPages449();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page449, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page449);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear449);
