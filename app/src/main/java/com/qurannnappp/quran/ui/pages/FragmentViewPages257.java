 ...
 * Use the {@link FragmentViewPages257#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages257 extends Fragment {
    ...
    public static FragmentViewPages257 newInstance(String param1, String param2) {
        FragmentViewPages257 fragment = new FragmentViewPages257();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page257, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page257);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear257);
