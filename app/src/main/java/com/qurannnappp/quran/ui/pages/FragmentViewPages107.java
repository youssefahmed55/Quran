 ...
 * Use the {@link FragmentViewPages107#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages107 extends Fragment {
    ...
    public static FragmentViewPages107 newInstance(String param1, String param2) {
        FragmentViewPages107 fragment = new FragmentViewPages107();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page107, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page107);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear107);
