 ...
 * Use the {@link FragmentViewPages273#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages273 extends Fragment {
    ...
    public static FragmentViewPages273 newInstance(String param1, String param2) {
        FragmentViewPages273 fragment = new FragmentViewPages273();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page273, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page273);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear273);
