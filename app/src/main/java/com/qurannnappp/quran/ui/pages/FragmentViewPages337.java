 ...
 * Use the {@link FragmentViewPages337#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages337 extends Fragment {
    ...
    public static FragmentViewPages337 newInstance(String param1, String param2) {
        FragmentViewPages337 fragment = new FragmentViewPages337();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page337, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page337);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear337);
