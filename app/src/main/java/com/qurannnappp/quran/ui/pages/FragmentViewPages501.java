 ...
 * Use the {@link FragmentViewPages501#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages501 extends Fragment {
    ...
    public static FragmentViewPages501 newInstance(String param1, String param2) {
        FragmentViewPages501 fragment = new FragmentViewPages501();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page501, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page501);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear501);
