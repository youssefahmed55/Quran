 ...
 * Use the {@link FragmentViewPages445#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages445 extends Fragment {
    ...
    public static FragmentViewPages445 newInstance(String param1, String param2) {
        FragmentViewPages445 fragment = new FragmentViewPages445();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page445, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page445);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear445);
