 ...
 * Use the {@link FragmentViewPages433#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages433 extends Fragment {
    ...
    public static FragmentViewPages433 newInstance(String param1, String param2) {
        FragmentViewPages433 fragment = new FragmentViewPages433();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page433, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page433);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear433);
