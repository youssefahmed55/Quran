 ...
 * Use the {@link FragmentViewPages465#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages465 extends Fragment {
    ...
    public static FragmentViewPages465 newInstance(String param1, String param2) {
        FragmentViewPages465 fragment = new FragmentViewPages465();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page465, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page465);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear465);
