 ...
 * Use the {@link FragmentViewPages293#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages293 extends Fragment {
    ...
    public static FragmentViewPages293 newInstance(String param1, String param2) {
        FragmentViewPages293 fragment = new FragmentViewPages293();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page293, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear293);
        linearLayout2 = viewGroup.findViewById(R.id.linear293_2);
        s = getActivity().getResources().getString(R.string.page293);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page293_2);
        views.clear();
