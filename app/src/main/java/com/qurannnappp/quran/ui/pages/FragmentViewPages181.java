 ...
 * Use the {@link FragmentViewPages181#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages181 extends Fragment {
    ...
    public static FragmentViewPages181 newInstance(String param1, String param2) {
        FragmentViewPages181 fragment = new FragmentViewPages181();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page181, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page181);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear181);
