 ...
 * Use the {@link FragmentViewPages305#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages305 extends Fragment {
    ...
    public static FragmentViewPages305 newInstance(String param1, String param2) {
        FragmentViewPages305 fragment = new FragmentViewPages305();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page305, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page305);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear305);
