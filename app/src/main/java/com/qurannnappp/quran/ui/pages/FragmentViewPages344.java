 ...
 * Use the {@link FragmentViewPages344#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages344 extends Fragment {
    ...
    public static FragmentViewPages344 newInstance(String param1, String param2) {
        FragmentViewPages344 fragment = new FragmentViewPages344();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page344, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page344);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear344);
