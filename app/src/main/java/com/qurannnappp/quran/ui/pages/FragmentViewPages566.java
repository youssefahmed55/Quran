 ...
 * Use the {@link FragmentViewPages566#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages566 extends Fragment {
    ...
    public static FragmentViewPages566 newInstance(String param1, String param2) {
        FragmentViewPages566 fragment = new FragmentViewPages566();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page566, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear566);
        linearLayout2 = viewGroup.findViewById(R.id.linear566_2);
        s = getActivity().getResources().getString(R.string.page566);
        ...
        for (String word : s.split(" ")){
            ...
            switch (i){
                ...
                case 11 :
                    ...
                    imageView.setImageResource(R.drawable.num43);
                    views.add(imageView);
                    break;
                case 21 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num44);
                    views.add(imageView);
                    break;
                case 26 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num45);
                    views.add(imageView);
                    break;
                case 33 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num46);
                    views.add(imageView);
                    break;
                case 38 :
                    imageView = new ImageView(getActivity());
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page566_2);
        views.clear();
