 ...
 * Use the {@link FragmentViewPages108#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages108 extends Fragment {
    ...
    public static FragmentViewPages108 newInstance(String param1, String param2) {
        FragmentViewPages108 fragment = new FragmentViewPages108();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page108, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page108);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear108);
