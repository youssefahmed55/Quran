 ...
 * Use the {@link FragmentViewPages228#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages228 extends Fragment {
    ...
    public static FragmentViewPages228 newInstance(String param1, String param2) {
        FragmentViewPages228 fragment = new FragmentViewPages228();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page228, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page228);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear228);
