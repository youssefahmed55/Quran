 ...
 * Use the {@link FragmentViewPages498#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages498 extends Fragment {
    ...
    public static FragmentViewPages498 newInstance(String param1, String param2) {
        FragmentViewPages498 fragment = new FragmentViewPages498();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page498, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page498);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear498);
