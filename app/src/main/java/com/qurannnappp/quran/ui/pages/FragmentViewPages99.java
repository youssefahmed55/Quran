 ...
 * Use the {@link FragmentViewPages99#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages99 extends Fragment {
    ...
    public static FragmentViewPages99 newInstance(String param1, String param2) {
        FragmentViewPages99 fragment = new FragmentViewPages99();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page99, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page99);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear99);
