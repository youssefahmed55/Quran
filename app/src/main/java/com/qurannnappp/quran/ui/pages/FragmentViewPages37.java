 ...
 * Use the {@link FragmentViewPages37#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages37 extends Fragment {
    ...
    public static FragmentViewPages37 newInstance(String param1, String param2) {
        FragmentViewPages37 fragment = new FragmentViewPages37();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page37, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page37);
        ...
        for (String word : s.split(" ")){
            ...
            switch (i){
                case 45 :
                    ...
                    imageView.setImageResource(R.drawable.num231);
                    views.add(imageView);
                    break;
                case 78 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num232);
                    views.add(imageView);
                    imageView = new ImageView(getActivity());
                ...
                case 142 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num233);
                    views.add(imageView);
                    break;
        ...
        linearLayout = viewGroup.findViewById(R.id.linear37);
