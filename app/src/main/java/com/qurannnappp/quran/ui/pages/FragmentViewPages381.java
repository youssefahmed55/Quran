 ...
 * Use the {@link FragmentViewPages381#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages381 extends Fragment {
    ...
    public static FragmentViewPages381 newInstance(String param1, String param2) {
        FragmentViewPages381 fragment = new FragmentViewPages381();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page381, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page381);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear381);
