 ...
 * Use the {@link FragmentViewPages237#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages237 extends Fragment {
    ...
    public static FragmentViewPages237 newInstance(String param1, String param2) {
        FragmentViewPages237 fragment = new FragmentViewPages237();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page237, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page237);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear237);
