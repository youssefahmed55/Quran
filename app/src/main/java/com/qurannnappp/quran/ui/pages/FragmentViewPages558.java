 ...
 * Use the {@link FragmentViewPages558#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages558 extends Fragment {
    ...
    public static FragmentViewPages558 newInstance(String param1, String param2) {
        FragmentViewPages558 fragment = new FragmentViewPages558();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page558, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page558);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear558);
