 ...
 * Use the {@link FragmentViewPages278#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages278 extends Fragment {
    ...
    public static FragmentViewPages278 newInstance(String param1, String param2) {
        FragmentViewPages278 fragment = new FragmentViewPages278();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page278, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page278);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear278);
