 ...
 * Use the {@link FragmentViewPages377#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages377 extends Fragment {
    ...
    public static FragmentViewPages377 newInstance(String param1, String param2) {
        FragmentViewPages377 fragment = new FragmentViewPages377();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page377, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page377);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear377);
