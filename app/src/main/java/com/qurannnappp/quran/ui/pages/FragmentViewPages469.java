 ...
 * Use the {@link FragmentViewPages469#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages469 extends Fragment {
    ...
    public static FragmentViewPages469 newInstance(String param1, String param2) {
        FragmentViewPages469 fragment = new FragmentViewPages469();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page469, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page469);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear469);
