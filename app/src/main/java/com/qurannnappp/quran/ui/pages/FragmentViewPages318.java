 ...
 * Use the {@link FragmentViewPages318#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages318 extends Fragment {
    ...
    public static FragmentViewPages318 newInstance(String param1, String param2) {
        FragmentViewPages318 fragment = new FragmentViewPages318();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page318, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page318);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear318);
