 ...
 * Use the {@link FragmentViewPages243#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages243 extends Fragment {
    ...
    public static FragmentViewPages243 newInstance(String param1, String param2) {
        FragmentViewPages243 fragment = new FragmentViewPages243();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page243, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page243);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear243);
