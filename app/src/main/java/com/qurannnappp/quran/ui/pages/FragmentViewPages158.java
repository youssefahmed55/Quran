 ...
 * Use the {@link FragmentViewPages158#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages158 extends Fragment {
    ...
    public static FragmentViewPages158 newInstance(String param1, String param2) {
        FragmentViewPages158 fragment = new FragmentViewPages158();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page158, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page158);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear158);
