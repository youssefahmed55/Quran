 ...
 * Use the {@link FragmentViewPages157#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages157 extends Fragment {
    ...
    public static FragmentViewPages157 newInstance(String param1, String param2) {
        FragmentViewPages157 fragment = new FragmentViewPages157();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page157, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page157);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear157);
