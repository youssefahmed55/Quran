 ...
 * Use the {@link FragmentViewPages214#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages214 extends Fragment {
    ...
    public static FragmentViewPages214 newInstance(String param1, String param2) {
        FragmentViewPages214 fragment = new FragmentViewPages214();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page214, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page214);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear214);
