 ...
 * Use the {@link FragmentViewPages362#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages362 extends Fragment {
    ...
    public static FragmentViewPages362 newInstance(String param1, String param2) {
        FragmentViewPages362 fragment = new FragmentViewPages362();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page362, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page362);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear362);
