 ...
 * Use the {@link FragmentViewPages156#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages156 extends Fragment {
    ...
    public static FragmentViewPages156 newInstance(String param1, String param2) {
        FragmentViewPages156 fragment = new FragmentViewPages156();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page156, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page156);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear156);
