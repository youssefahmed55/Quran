 ...
 * Use the {@link FragmentViewPages403#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages403 extends Fragment {
    ...
    public static FragmentViewPages403 newInstance(String param1, String param2) {
        FragmentViewPages403 fragment = new FragmentViewPages403();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page403, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page403);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear403);
