 ...
 * Use the {@link FragmentViewPages208#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages208 extends Fragment {
    ...
    public static FragmentViewPages208 newInstance(String param1, String param2) {
        FragmentViewPages208 fragment = new FragmentViewPages208();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page208, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page208);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear208);
