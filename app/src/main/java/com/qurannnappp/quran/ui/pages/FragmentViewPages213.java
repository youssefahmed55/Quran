 ...
 * Use the {@link FragmentViewPages213#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages213 extends Fragment {
    ...
    public static FragmentViewPages213 newInstance(String param1, String param2) {
        FragmentViewPages213 fragment = new FragmentViewPages213();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page213, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page213);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear213);
