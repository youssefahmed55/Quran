 ...
 * Use the {@link FragmentViewPages410#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages410 extends Fragment {
    ...
    public static FragmentViewPages410 newInstance(String param1, String param2) {
        FragmentViewPages410 fragment = new FragmentViewPages410();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page410, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page410);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear410);
