 ...
 * Use the {@link FragmentViewPages531#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages531 extends Fragment {
    ...
    public static FragmentViewPages531 newInstance(String param1, String param2) {
        FragmentViewPages531 fragment = new FragmentViewPages531();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page531, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear531);
        linearLayout2 = viewGroup.findViewById(R.id.linear531_2);
        s = getActivity().getResources().getString(R.string.page531);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page531_2);
        views.clear();
