 ...
 * Use the {@link FragmentViewPages583#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages583 extends Fragment {
    ...
    public static FragmentViewPages583 newInstance(String param1, String param2) {
        FragmentViewPages583 fragment = new FragmentViewPages583();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page583, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear583);
        linearLayout2 = viewGroup.findViewById(R.id.linear583_2);
        s = getActivity().getResources().getString(R.string.page583);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page583_2);
        views.clear();
