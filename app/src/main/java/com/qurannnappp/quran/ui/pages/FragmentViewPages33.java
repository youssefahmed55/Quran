 ...
 * Use the {@link FragmentViewPages33#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages33 extends Fragment {
    ...
    public static FragmentViewPages33 newInstance(String param1, String param2) {
        FragmentViewPages33 fragment = new FragmentViewPages33();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page33, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page33);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear33);
