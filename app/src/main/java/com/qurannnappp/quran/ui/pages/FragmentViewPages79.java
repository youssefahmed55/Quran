 ...
 * Use the {@link FragmentViewPages79#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages79 extends Fragment {
    ...
    public static FragmentViewPages79 newInstance(String param1, String param2) {
        FragmentViewPages79 fragment = new FragmentViewPages79();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page79, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page79);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear79);
