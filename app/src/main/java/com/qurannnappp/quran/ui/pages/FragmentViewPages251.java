 ...
 * Use the {@link FragmentViewPages251#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages251 extends Fragment {
    ...
    public static FragmentViewPages251 newInstance(String param1, String param2) {
        FragmentViewPages251 fragment = new FragmentViewPages251();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page251, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page251);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear251);
