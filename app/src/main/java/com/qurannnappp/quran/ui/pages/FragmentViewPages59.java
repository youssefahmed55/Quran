 ...
 * Use the {@link FragmentViewPages59#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages59 extends Fragment {
    ...
    public static FragmentViewPages59 newInstance(String param1, String param2) {
        FragmentViewPages59 fragment = new FragmentViewPages59();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page59, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page59);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear59);
