 ...
 * Use the {@link FragmentViewPages312#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages312 extends Fragment {
    ...
    public static FragmentViewPages312 newInstance(String param1, String param2) {
        FragmentViewPages312 fragment = new FragmentViewPages312();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page312, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear312);
        linearLayout2 = viewGroup.findViewById(R.id.linear312_2);
        s = getActivity().getResources().getString(R.string.page312);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page312_2);
        views.clear();
