 ...
 * Use the {@link FragmentViewPages394#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages394 extends Fragment {
    ...
    public static FragmentViewPages394 newInstance(String param1, String param2) {
        FragmentViewPages394 fragment = new FragmentViewPages394();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page394, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page394);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear394);
