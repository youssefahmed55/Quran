 ...
 * Use the {@link FragmentViewPages69#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages69 extends Fragment {
    ...
    public static FragmentViewPages69 newInstance(String param1, String param2) {
        FragmentViewPages69 fragment = new FragmentViewPages69();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page69, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page69);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear69);
