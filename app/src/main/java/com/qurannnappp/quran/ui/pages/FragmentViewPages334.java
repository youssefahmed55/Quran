 ...
 * Use the {@link FragmentViewPages334#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages334 extends Fragment {
    ...
    public static FragmentViewPages334 newInstance(String param1, String param2) {
        FragmentViewPages334 fragment = new FragmentViewPages334();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page334, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page334);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear334);
