 ...
 * Use the {@link FragmentViewPages162#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages162 extends Fragment {
    ...
    public static FragmentViewPages162 newInstance(String param1, String param2) {
        FragmentViewPages162 fragment = new FragmentViewPages162();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page162, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page162);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear162);
