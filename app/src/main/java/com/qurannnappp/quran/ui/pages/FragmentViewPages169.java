 ...
 * Use the {@link FragmentViewPages169#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages169 extends Fragment {
    ...
    public static FragmentViewPages169 newInstance(String param1, String param2) {
        FragmentViewPages169 fragment = new FragmentViewPages169();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page169, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page169);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear169);
