 ...
 * Use the {@link FragmentViewPages335#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages335 extends Fragment {
    ...
    public static FragmentViewPages335 newInstance(String param1, String param2) {
        FragmentViewPages335 fragment = new FragmentViewPages335();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page335, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page335);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear335);
