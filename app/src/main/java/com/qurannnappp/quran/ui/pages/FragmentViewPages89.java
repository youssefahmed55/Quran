 ...
 * Use the {@link FragmentViewPages89#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages89 extends Fragment {
    ...
    public static FragmentViewPages89 newInstance(String param1, String param2) {
        FragmentViewPages89 fragment = new FragmentViewPages89();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page89, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page89);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear89);
