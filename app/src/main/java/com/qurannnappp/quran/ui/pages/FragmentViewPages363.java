 ...
 * Use the {@link FragmentViewPages363#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages363 extends Fragment {
    ...
    public static FragmentViewPages363 newInstance(String param1, String param2) {
        FragmentViewPages363 fragment = new FragmentViewPages363();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page363, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page363);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear363);
