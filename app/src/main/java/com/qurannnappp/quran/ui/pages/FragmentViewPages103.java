 ...
 * Use the {@link FragmentViewPages103#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages103 extends Fragment {
    ...
    public static FragmentViewPages103 newInstance(String param1, String param2) {
        FragmentViewPages103 fragment = new FragmentViewPages103();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page103, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page103);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear103);
