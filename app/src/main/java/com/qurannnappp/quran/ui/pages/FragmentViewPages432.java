 ...
 * Use the {@link FragmentViewPages432#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages432 extends Fragment {
    ...
    public static FragmentViewPages432 newInstance(String param1, String param2) {
        FragmentViewPages432 fragment = new FragmentViewPages432();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page432, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page432);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear432);
