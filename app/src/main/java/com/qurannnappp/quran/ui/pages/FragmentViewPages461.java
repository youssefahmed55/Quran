 ...
 * Use the {@link FragmentViewPages461#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages461 extends Fragment {
    ...
    public static FragmentViewPages461 newInstance(String param1, String param2) {
        FragmentViewPages461 fragment = new FragmentViewPages461();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page461, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page461);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear461);
