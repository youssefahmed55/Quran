 ...
 * Use the {@link FragmentViewPages365#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages365 extends Fragment {
    ...
    public static FragmentViewPages365 newInstance(String param1, String param2) {
        FragmentViewPages365 fragment = new FragmentViewPages365();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page365, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page365);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear365);
