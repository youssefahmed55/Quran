 ...
 * Use the {@link FragmentViewPages154#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages154 extends Fragment {
    ...
    public static FragmentViewPages154 newInstance(String param1, String param2) {
        FragmentViewPages154 fragment = new FragmentViewPages154();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page154, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page154);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear154);
