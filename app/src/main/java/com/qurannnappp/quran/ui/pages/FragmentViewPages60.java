 ...
 * Use the {@link FragmentViewPages60#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages60 extends Fragment {
    ...
    public static FragmentViewPages60 newInstance(String param1, String param2) {
        FragmentViewPages60 fragment = new FragmentViewPages60();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page60, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page60);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear60);
