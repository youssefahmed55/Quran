 ...
 * Use the {@link FragmentViewPages586#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages586 extends Fragment {
    ...
    public static FragmentViewPages586 newInstance(String param1, String param2) {
        FragmentViewPages586 fragment = new FragmentViewPages586();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page586, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page586);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear586);
