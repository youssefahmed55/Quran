 ...
 * Use the {@link FragmentViewPages439#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages439 extends Fragment {
    ...
    public static FragmentViewPages439 newInstance(String param1, String param2) {
        FragmentViewPages439 fragment = new FragmentViewPages439();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page439, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page439);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear439);
