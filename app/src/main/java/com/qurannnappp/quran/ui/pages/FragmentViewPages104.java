 ...
 * Use the {@link FragmentViewPages104#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages104 extends Fragment {
    ...
    public static FragmentViewPages104 newInstance(String param1, String param2) {
        FragmentViewPages104 fragment = new FragmentViewPages104();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page104, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page104);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear104);
