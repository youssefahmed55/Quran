 ...
 * Use the {@link FragmentViewPages168#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages168 extends Fragment {
    ...
    public static FragmentViewPages168 newInstance(String param1, String param2) {
        FragmentViewPages168 fragment = new FragmentViewPages168();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page168, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page168);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear168);
