 ...
 * Use the {@link FragmentViewPages265#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages265 extends Fragment {
    ...
    public static FragmentViewPages265 newInstance(String param1, String param2) {
        FragmentViewPages265 fragment = new FragmentViewPages265();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page265, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page265);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear265);
