 ...
 * Use the {@link FragmentViewPages61#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages61 extends Fragment {
    ...
    public static FragmentViewPages61 newInstance(String param1, String param2) {
        FragmentViewPages61 fragment = new FragmentViewPages61();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page61, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page61);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear61);
