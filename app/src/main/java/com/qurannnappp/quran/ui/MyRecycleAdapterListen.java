...
import com.qurannnappp.quran.pojo.ModelListen;

import java.util.ArrayList;

public class MyRecycleAdapterListen extends RecyclerView.Adapter<MyRecycleAdapterListen.Holder> {

    ArrayList<ModelListen> arrayList;
    OnClickListenerr onClickListenerr;
    public void setArrayList(ArrayList<ModelListen> arrayList) {
