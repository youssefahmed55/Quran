 ...
 * Use the {@link FragmentViewPages582#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages582 extends Fragment {
    ...
    public static FragmentViewPages582 newInstance(String param1, String param2) {
        FragmentViewPages582 fragment = new FragmentViewPages582();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page582, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page582);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear582);
