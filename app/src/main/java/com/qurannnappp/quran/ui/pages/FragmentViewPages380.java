 ...
 * Use the {@link FragmentViewPages380#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages380 extends Fragment {
    ...
    public static FragmentViewPages380 newInstance(String param1, String param2) {
        FragmentViewPages380 fragment = new FragmentViewPages380();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page380, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page380);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear380);
