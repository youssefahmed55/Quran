 ...
 * Use the {@link FragmentViewPages239#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages239 extends Fragment {
    ...
    public static FragmentViewPages239 newInstance(String param1, String param2) {
        FragmentViewPages239 fragment = new FragmentViewPages239();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page239, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page239);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear239);
