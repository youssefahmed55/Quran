 ...
 * Use the {@link FragmentViewPages229#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages229 extends Fragment {
    ...
    public static FragmentViewPages229 newInstance(String param1, String param2) {
        FragmentViewPages229 fragment = new FragmentViewPages229();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page229, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page229);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear229);
