 ...
 * Use the {@link FragmentViewPages506#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages506 extends Fragment {
    ...
    public static FragmentViewPages506 newInstance(String param1, String param2) {
        FragmentViewPages506 fragment = new FragmentViewPages506();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page506, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page506);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear506);
