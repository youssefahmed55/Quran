 ...
 * Use the {@link FragmentViewPages556#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages556 extends Fragment {
    ...
    public static FragmentViewPages556 newInstance(String param1, String param2) {
        FragmentViewPages556 fragment = new FragmentViewPages556();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page556, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page556);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear556);
