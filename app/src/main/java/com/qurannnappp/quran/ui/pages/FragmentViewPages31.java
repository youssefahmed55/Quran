 ...
 * Use the {@link FragmentViewPages31#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages31 extends Fragment {
    ...
    public static FragmentViewPages31 newInstance(String param1, String param2) {
        FragmentViewPages31 fragment = new FragmentViewPages31();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page31, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page31);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear31);
