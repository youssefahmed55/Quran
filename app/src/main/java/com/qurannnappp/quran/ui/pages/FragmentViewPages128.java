 ...
 * Use the {@link FragmentViewPages128#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages128 extends Fragment {
    ...
    public static FragmentViewPages128 newInstance(String param1, String param2) {
        FragmentViewPages128 fragment = new FragmentViewPages128();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page128, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page128);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear128);
