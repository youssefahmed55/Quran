 ...
 * Use the {@link FragmentViewPages588#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages588 extends Fragment {
    ...
    public static FragmentViewPages588 newInstance(String param1, String param2) {
        FragmentViewPages588 fragment = new FragmentViewPages588();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page588, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page588);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear588);
