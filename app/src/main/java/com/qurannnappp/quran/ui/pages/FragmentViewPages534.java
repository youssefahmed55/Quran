 ...
 * Use the {@link FragmentViewPages534#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages534 extends Fragment {
    ...
    public static FragmentViewPages534 newInstance(String param1, String param2) {
        FragmentViewPages534 fragment = new FragmentViewPages534();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page534, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear534);
        linearLayout2 = viewGroup.findViewById(R.id.linear534_2);
        s = getActivity().getResources().getString(R.string.page534);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page534_2);
        views.clear();
