 ...
 * Use the {@link FragmentViewPages426#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages426 extends Fragment {
    ...
    public static FragmentViewPages426 newInstance(String param1, String param2) {
        FragmentViewPages426 fragment = new FragmentViewPages426();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page426, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page426);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear426);
