 ...
 * Use the {@link FragmentViewPages295#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages295 extends Fragment {
    ...
    public static FragmentViewPages295 newInstance(String param1, String param2) {
        FragmentViewPages295 fragment = new FragmentViewPages295();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page295, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page295);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear295);
