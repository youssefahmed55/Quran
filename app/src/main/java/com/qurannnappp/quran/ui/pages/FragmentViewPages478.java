 ...
 * Use the {@link FragmentViewPages478#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages478 extends Fragment {
    ...
    public static FragmentViewPages478 newInstance(String param1, String param2) {
        FragmentViewPages478 fragment = new FragmentViewPages478();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page478, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page478);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear478);
