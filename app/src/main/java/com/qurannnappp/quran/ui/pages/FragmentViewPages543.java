 ...
 * Use the {@link FragmentViewPages543#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages543 extends Fragment {
    ...
    public static FragmentViewPages543 newInstance(String param1, String param2) {
        FragmentViewPages543 fragment = new FragmentViewPages543();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page543, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page543);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear543);
