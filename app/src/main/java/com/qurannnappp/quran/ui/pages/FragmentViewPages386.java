 ...
 * Use the {@link FragmentViewPages386#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages386 extends Fragment {
    ...
    public static FragmentViewPages386 newInstance(String param1, String param2) {
        FragmentViewPages386 fragment = new FragmentViewPages386();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page386, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page386);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear386);
