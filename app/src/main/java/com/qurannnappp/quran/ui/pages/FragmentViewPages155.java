 ...
 * Use the {@link FragmentViewPages155#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages155 extends Fragment {
    ...
    public static FragmentViewPages155 newInstance(String param1, String param2) {
        FragmentViewPages155 fragment = new FragmentViewPages155();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page155, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page155);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear155);
