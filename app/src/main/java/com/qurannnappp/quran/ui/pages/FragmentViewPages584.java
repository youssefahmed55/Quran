 ...
 * Use the {@link FragmentViewPages584#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages584 extends Fragment {
    ...
    public static FragmentViewPages584 newInstance(String param1, String param2) {
        FragmentViewPages584 fragment = new FragmentViewPages584();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page584, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page584);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear584);
