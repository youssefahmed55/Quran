 ...
 * Use the {@link FragmentViewPages407#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages407 extends Fragment {
    ...
    public static FragmentViewPages407 newInstance(String param1, String param2) {
        FragmentViewPages407 fragment = new FragmentViewPages407();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page407, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page407);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear407);
