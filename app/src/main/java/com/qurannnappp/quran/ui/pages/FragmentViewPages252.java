 ...
 * Use the {@link FragmentViewPages252#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages252 extends Fragment {
    ...
    public static FragmentViewPages252 newInstance(String param1, String param2) {
        FragmentViewPages252 fragment = new FragmentViewPages252();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page252, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page252);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear252);
