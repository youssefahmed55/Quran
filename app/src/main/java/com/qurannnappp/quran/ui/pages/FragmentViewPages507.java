 ...
 * Use the {@link FragmentViewPages507#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages507 extends Fragment {
    ...
    public static FragmentViewPages507 newInstance(String param1, String param2) {
        FragmentViewPages507 fragment = new FragmentViewPages507();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page507, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page507);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear507);
