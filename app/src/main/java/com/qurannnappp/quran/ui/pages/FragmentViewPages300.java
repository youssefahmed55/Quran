 ...
 * Use the {@link FragmentViewPages300#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages300 extends Fragment {
    ...
    public static FragmentViewPages300 newInstance(String param1, String param2) {
        FragmentViewPages300 fragment = new FragmentViewPages300();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page300, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page300);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear300);
