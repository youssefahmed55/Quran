 ...
 * Use the {@link FragmentViewPages570#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages570 extends Fragment {
    ...
    public static FragmentViewPages570 newInstance(String param1, String param2) {
        FragmentViewPages570 fragment = new FragmentViewPages570();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page570, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear570);
        linearLayout2 = viewGroup.findViewById(R.id.linear570_2);
        s = getActivity().getResources().getString(R.string.page570);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page570_2);
        views.clear();
