 ...
 * Use the {@link FragmentViewPages297#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages297 extends Fragment {
    ...
    public static FragmentViewPages297 newInstance(String param1, String param2) {
        FragmentViewPages297 fragment = new FragmentViewPages297();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page297, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page297);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear297);
