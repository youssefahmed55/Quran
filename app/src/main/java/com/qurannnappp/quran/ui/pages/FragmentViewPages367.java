 ...
 * Use the {@link FragmentViewPages367#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages367 extends Fragment {
    ...
    public static FragmentViewPages367 newInstance(String param1, String param2) {
        FragmentViewPages367 fragment = new FragmentViewPages367();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page367, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page367);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear367);
