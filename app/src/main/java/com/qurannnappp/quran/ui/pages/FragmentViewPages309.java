 ...
 * Use the {@link FragmentViewPages309#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages309 extends Fragment {
    ...
    public static FragmentViewPages309 newInstance(String param1, String param2) {
        FragmentViewPages309 fragment = new FragmentViewPages309();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page309, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page309);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear309);
