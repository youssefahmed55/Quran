 ...
 * Use the {@link FragmentViewPages416#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages416 extends Fragment {
    ...
    public static FragmentViewPages416 newInstance(String param1, String param2) {
        FragmentViewPages416 fragment = new FragmentViewPages416();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page416, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page416);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear416);
