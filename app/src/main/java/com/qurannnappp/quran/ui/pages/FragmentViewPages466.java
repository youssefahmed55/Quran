 ...
 * Use the {@link FragmentViewPages466#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages466 extends Fragment {
    ...
    public static FragmentViewPages466 newInstance(String param1, String param2) {
        FragmentViewPages466 fragment = new FragmentViewPages466();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page466, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page466);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear466);
