 ...
 * Use the {@link FragmentViewPages398#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages398 extends Fragment {
    ...
    public static FragmentViewPages398 newInstance(String param1, String param2) {
        FragmentViewPages398 fragment = new FragmentViewPages398();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page398, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page398);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear398);
