 ...
 * Use the {@link FragmentViewPages339#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages339 extends Fragment {
    ...
    public static FragmentViewPages339 newInstance(String param1, String param2) {
        FragmentViewPages339 fragment = new FragmentViewPages339();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page339, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page339);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear339);
