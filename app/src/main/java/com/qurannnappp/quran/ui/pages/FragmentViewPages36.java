 ...
 * Use the {@link FragmentViewPages36#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages36 extends Fragment {
    ...
    public static FragmentViewPages36 newInstance(String param1, String param2) {
        FragmentViewPages36 fragment = new FragmentViewPages36();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page36, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page36);
        ...
        for (String word : s.split(" ")){
            ...
            switch (i){
                ...
                case 74 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num228);
                    views.add(imageView);
                    break;
                case 120 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num229);
                    views.add(imageView);
                    break;
                case 150 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num230);
                    views.add(imageView);
                    break;
        ...
        linearLayout = viewGroup.findViewById(R.id.linear36);
