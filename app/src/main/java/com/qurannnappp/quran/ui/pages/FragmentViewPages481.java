 ...
 * Use the {@link FragmentViewPages481#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages481 extends Fragment {
    ...
    public static FragmentViewPages481 newInstance(String param1, String param2) {
        FragmentViewPages481 fragment = new FragmentViewPages481();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page481, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page481);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear481);
