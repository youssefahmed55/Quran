 ...
 * Use the {@link FragmentViewPages218#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages218 extends Fragment {
    ...
    public static FragmentViewPages218 newInstance(String param1, String param2) {
        FragmentViewPages218 fragment = new FragmentViewPages218();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page218, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page218);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear218);
