 ...
 * Use the {@link FragmentViewPages505#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages505 extends Fragment {
    ...
    public static FragmentViewPages505 newInstance(String param1, String param2) {
        FragmentViewPages505 fragment = new FragmentViewPages505();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page505, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page505);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear505);
