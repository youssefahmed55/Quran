 ...
 * Use the {@link FragmentViewPages424#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages424 extends Fragment {
    ...
    public static FragmentViewPages424 newInstance(String param1, String param2) {
        FragmentViewPages424 fragment = new FragmentViewPages424();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page424, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page424);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear424);
