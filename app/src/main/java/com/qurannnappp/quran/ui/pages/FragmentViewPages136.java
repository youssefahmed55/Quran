 ...
 * Use the {@link FragmentViewPages136#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages136 extends Fragment {
    ...
    public static FragmentViewPages136 newInstance(String param1, String param2) {
        FragmentViewPages136 fragment = new FragmentViewPages136();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page136, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page136);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear136);
