 ...
 * Use the {@link FragmentViewPages258#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages258 extends Fragment {
    ...
    public static FragmentViewPages258 newInstance(String param1, String param2) {
        FragmentViewPages258 fragment = new FragmentViewPages258();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page258, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page258);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear258);
