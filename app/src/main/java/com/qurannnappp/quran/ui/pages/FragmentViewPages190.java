 ...
 * Use the {@link FragmentViewPages190#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages190 extends Fragment {
    ...
    public static FragmentViewPages190 newInstance(String param1, String param2) {
        FragmentViewPages190 fragment = new FragmentViewPages190();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page190, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page190);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear190);
