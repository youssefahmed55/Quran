 ...
 * Use the {@link FragmentViewPages134#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages134 extends Fragment {
    ...
    public static FragmentViewPages134 newInstance(String param1, String param2) {
        FragmentViewPages134 fragment = new FragmentViewPages134();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page134, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page134);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear134);
