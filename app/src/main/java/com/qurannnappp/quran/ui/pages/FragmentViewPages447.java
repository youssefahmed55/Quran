 ...
 * Use the {@link FragmentViewPages447#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages447 extends Fragment {
    ...
    public static FragmentViewPages447 newInstance(String param1, String param2) {
        FragmentViewPages447 fragment = new FragmentViewPages447();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page447, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page447);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear447);
