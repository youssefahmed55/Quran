 ...
 * Use the {@link FragmentViewPages316#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages316 extends Fragment {
    ...
    public static FragmentViewPages316 newInstance(String param1, String param2) {
        FragmentViewPages316 fragment = new FragmentViewPages316();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page316, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page316);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear316);
