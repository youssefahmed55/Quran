 ...
 * Use the {@link FragmentViewPages462#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages462 extends Fragment {
    ...
    public static FragmentViewPages462 newInstance(String param1, String param2) {
        FragmentViewPages462 fragment = new FragmentViewPages462();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page462, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page462);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear462);
