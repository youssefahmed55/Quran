 ...
 * Use the {@link FragmentViewPages351#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages351 extends Fragment {
    ...
    public static FragmentViewPages351 newInstance(String param1, String param2) {
        FragmentViewPages351 fragment = new FragmentViewPages351();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page351, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page351);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear351);
