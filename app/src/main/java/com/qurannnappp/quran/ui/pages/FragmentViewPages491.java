 ...
 * Use the {@link FragmentViewPages491#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages491 extends Fragment {
    ...
    public static FragmentViewPages491 newInstance(String param1, String param2) {
        FragmentViewPages491 fragment = new FragmentViewPages491();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page491, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page491);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear491);
