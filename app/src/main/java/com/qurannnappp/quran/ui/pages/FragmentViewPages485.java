 ...
 * Use the {@link FragmentViewPages485#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages485 extends Fragment {
    ...
    public static FragmentViewPages485 newInstance(String param1, String param2) {
        FragmentViewPages485 fragment = new FragmentViewPages485();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page485, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page485);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear485);
