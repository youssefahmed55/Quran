 ...
 * Use the {@link FragmentViewPages256#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages256 extends Fragment {
    ...
    public static FragmentViewPages256 newInstance(String param1, String param2) {
        FragmentViewPages256 fragment = new FragmentViewPages256();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page256, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page256);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear256);
