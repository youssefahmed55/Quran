 ...
 * Use the {@link FragmentViewPages91#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages91 extends Fragment {
    ...
    public static FragmentViewPages91 newInstance(String param1, String param2) {
        FragmentViewPages91 fragment = new FragmentViewPages91();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page91, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page91);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear91);
