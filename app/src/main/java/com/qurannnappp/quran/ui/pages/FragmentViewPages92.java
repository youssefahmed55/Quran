 ...
 * Use the {@link FragmentViewPages92#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages92 extends Fragment {
    ...
    public static FragmentViewPages92 newInstance(String param1, String param2) {
        FragmentViewPages92 fragment = new FragmentViewPages92();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page92, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page92);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear92);
