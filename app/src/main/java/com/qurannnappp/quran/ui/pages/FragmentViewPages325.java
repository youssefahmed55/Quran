 ...
 * Use the {@link FragmentViewPages325#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages325 extends Fragment {
    ...
    public static FragmentViewPages325 newInstance(String param1, String param2) {
        FragmentViewPages325 fragment = new FragmentViewPages325();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page325, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page325);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear325);
