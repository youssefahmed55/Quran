 ...
 * Use the {@link FragmentViewPages283#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages283 extends Fragment {
    ...
    public static FragmentViewPages283 newInstance(String param1, String param2) {
        FragmentViewPages283 fragment = new FragmentViewPages283();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page283, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page283);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear283);
