 ...
 * Use the {@link FragmentViewPages307#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages307 extends Fragment {
    ...
    public static FragmentViewPages307 newInstance(String param1, String param2) {
        FragmentViewPages307 fragment = new FragmentViewPages307();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page307, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page307);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear307);
