 ...
 * Use the {@link FragmentViewPages62#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages62 extends Fragment {
    ...
    public static FragmentViewPages62 newInstance(String param1, String param2) {
        FragmentViewPages62 fragment = new FragmentViewPages62();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page62, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page62);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear62);
