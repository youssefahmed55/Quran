 ...
 * Use the {@link FragmentViewPages575#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages575 extends Fragment {
    ...
    public static FragmentViewPages575 newInstance(String param1, String param2) {
        FragmentViewPages575 fragment = new FragmentViewPages575();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page575, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear575);
        linearLayout2 = viewGroup.findViewById(R.id.linear575_2);
        s = getActivity().getResources().getString(R.string.page575);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page575_2);
        views.clear();
