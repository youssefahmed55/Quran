 ...
 * Use the {@link FragmentViewPages110#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages110 extends Fragment {
    ...
    public static FragmentViewPages110 newInstance(String param1, String param2) {
        FragmentViewPages110 fragment = new FragmentViewPages110();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page110, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page110);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear110);
