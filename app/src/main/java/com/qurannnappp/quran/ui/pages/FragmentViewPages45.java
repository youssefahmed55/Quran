 ...
 * Use the {@link FragmentViewPages45#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages45 extends Fragment {
    ...
    public static FragmentViewPages45 newInstance(String param1, String param2) {
        FragmentViewPages45 fragment = new FragmentViewPages45();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page45, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page45);
        ...
        for (String word : s.split(" ")){
            ...
            switch (i){
                case 27 :
                    ...
                    imageView.setImageResource(R.drawable.num265);
                    views.add(imageView);
                    break;
                case 62 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num266);
                    views.add(imageView);
                    break;
                case 92 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num267);
                    views.add(imageView);
                    break;
                case 105 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num268);
                    views.add(imageView);
                    break;
                case 121 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num269);
                    views.add(imageView);
                    break;
        ...
        linearLayout = viewGroup.findViewById(R.id.linear45);
