 ...
 * Use the {@link FragmentViewPages356#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages356 extends Fragment {
    ...
    public static FragmentViewPages356 newInstance(String param1, String param2) {
        FragmentViewPages356 fragment = new FragmentViewPages356();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page356, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page356);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear356);
