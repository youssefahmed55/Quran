 ...
 * Use the {@link FragmentViewPages58#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages58 extends Fragment {
    ...
    public static FragmentViewPages58 newInstance(String param1, String param2) {
        FragmentViewPages58 fragment = new FragmentViewPages58();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page58, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page58);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear58);
