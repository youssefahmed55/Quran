 ...
 * Use the {@link FragmentViewPages139#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages139 extends Fragment {
    ...
    public static FragmentViewPages139 newInstance(String param1, String param2) {
        FragmentViewPages139 fragment = new FragmentViewPages139();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page139, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page139);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear139);
