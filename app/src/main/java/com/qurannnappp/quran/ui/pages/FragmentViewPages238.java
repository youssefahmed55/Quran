 ...
 * Use the {@link FragmentViewPages238#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages238 extends Fragment {
    ...
    public static FragmentViewPages238 newInstance(String param1, String param2) {
        FragmentViewPages238 fragment = new FragmentViewPages238();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page238, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page238);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear238);
