 ...
 * Use the {@link FragmentViewPages96#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages96 extends Fragment {
    ...
    public static FragmentViewPages96 newInstance(String param1, String param2) {
        FragmentViewPages96 fragment = new FragmentViewPages96();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page96, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page96);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear96);
