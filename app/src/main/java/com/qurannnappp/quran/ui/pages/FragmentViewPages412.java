 ...
 * Use the {@link FragmentViewPages412#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages412 extends Fragment {
    ...
    public static FragmentViewPages412 newInstance(String param1, String param2) {
        FragmentViewPages412 fragment = new FragmentViewPages412();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page412, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page412);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear412);
