 ...
 * Use the {@link FragmentViewPages317#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages317 extends Fragment {
    ...
    public static FragmentViewPages317 newInstance(String param1, String param2) {
        FragmentViewPages317 fragment = new FragmentViewPages317();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page317, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page317);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear317);
