 ...
 * Use the {@link FragmentViewPages455#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages455 extends Fragment {
    ...
    public static FragmentViewPages455 newInstance(String param1, String param2) {
        FragmentViewPages455 fragment = new FragmentViewPages455();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page455, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page455);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear455);
