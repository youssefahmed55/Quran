 ...
 * Use the {@link FragmentViewPages420#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages420 extends Fragment {
    ...
    public static FragmentViewPages420 newInstance(String param1, String param2) {
        FragmentViewPages420 fragment = new FragmentViewPages420();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page420, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page420);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear420);
