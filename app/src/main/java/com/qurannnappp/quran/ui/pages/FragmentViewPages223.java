 ...
 * Use the {@link FragmentViewPages223#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages223 extends Fragment {
    ...
    public static FragmentViewPages223 newInstance(String param1, String param2) {
        FragmentViewPages223 fragment = new FragmentViewPages223();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page223, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page223);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear223);
