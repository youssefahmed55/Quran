 ...
 * Use the {@link FragmentViewPages369#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages369 extends Fragment {
    ...
    public static FragmentViewPages369 newInstance(String param1, String param2) {
        FragmentViewPages369 fragment = new FragmentViewPages369();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page369, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page369);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear369);
