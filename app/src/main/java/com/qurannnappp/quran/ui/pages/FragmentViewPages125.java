 ...
 * Use the {@link FragmentViewPages125#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages125 extends Fragment {
    ...
    public static FragmentViewPages125 newInstance(String param1, String param2) {
        FragmentViewPages125 fragment = new FragmentViewPages125();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page125, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page125);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear125);
