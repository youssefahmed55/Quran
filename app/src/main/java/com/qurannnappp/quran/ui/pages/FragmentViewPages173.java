 ...
 * Use the {@link FragmentViewPages173#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages173 extends Fragment {
    ...
    public static FragmentViewPages173 newInstance(String param1, String param2) {
        FragmentViewPages173 fragment = new FragmentViewPages173();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page173, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page173);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear173);
