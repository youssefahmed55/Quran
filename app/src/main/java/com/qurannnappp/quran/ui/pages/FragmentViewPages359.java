 ...
 * Use the {@link FragmentViewPages359#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages359 extends Fragment {
    ...
    public static FragmentViewPages359 newInstance(String param1, String param2) {
        FragmentViewPages359 fragment = new FragmentViewPages359();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page359, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear359);
        linearLayout2 = viewGroup.findViewById(R.id.linear359_2);
        s = getActivity().getResources().getString(R.string.page359);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page359_2);
        views.clear();
