 ...
 * Use the {@link FragmentViewPages279#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages279 extends Fragment {
    ...
    public static FragmentViewPages279 newInstance(String param1, String param2) {
        FragmentViewPages279 fragment = new FragmentViewPages279();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page279, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page279);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear279);
