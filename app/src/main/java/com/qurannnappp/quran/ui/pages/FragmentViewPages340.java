 ...
 * Use the {@link FragmentViewPages340#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages340 extends Fragment {
    ...
    public static FragmentViewPages340 newInstance(String param1, String param2) {
        FragmentViewPages340 fragment = new FragmentViewPages340();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page340, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page340);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear340);
