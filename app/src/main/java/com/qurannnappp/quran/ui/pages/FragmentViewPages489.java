 ...
 * Use the {@link FragmentViewPages489#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages489 extends Fragment {
    ...
    public static FragmentViewPages489 newInstance(String param1, String param2) {
        FragmentViewPages489 fragment = new FragmentViewPages489();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page489, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear489);
        linearLayout2 = viewGroup.findViewById(R.id.linear489_2);
        s = getActivity().getResources().getString(R.string.page489);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page489_2);
        views.clear();
