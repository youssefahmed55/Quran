 ...
 * Use the {@link FragmentViewPages577#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages577 extends Fragment {
    ...
    public static FragmentViewPages577 newInstance(String param1, String param2) {
        FragmentViewPages577 fragment = new FragmentViewPages577();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page577, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear577);
        linearLayout2 = viewGroup.findViewById(R.id.linear577_2);
        s = getActivity().getResources().getString(R.string.page577);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page577_2);
        views.clear();
