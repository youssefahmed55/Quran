 ...
 * Use the {@link FragmentViewPages396#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages396 extends Fragment {
    ...
    public static FragmentViewPages396 newInstance(String param1, String param2) {
        FragmentViewPages396 fragment = new FragmentViewPages396();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page396, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear396);
        linearLayout2 = viewGroup.findViewById(R.id.linear396_2);
        s = getActivity().getResources().getString(R.string.page396);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page396_2);
        views.clear();
