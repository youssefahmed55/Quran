 ...
 * Use the {@link FragmentViewPages418#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages418 extends Fragment {
    ...
    public static FragmentViewPages418 newInstance(String param1, String param2) {
        FragmentViewPages418 fragment = new FragmentViewPages418();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page418, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page418);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear418);
