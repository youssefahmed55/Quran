 ...
 * Use the {@link FragmentViewPages573#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages573 extends Fragment {
    ...
    public static FragmentViewPages573 newInstance(String param1, String param2) {
        FragmentViewPages573 fragment = new FragmentViewPages573();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page573, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page573);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear573);
