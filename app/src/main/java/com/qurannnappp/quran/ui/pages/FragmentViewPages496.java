 ...
 * Use the {@link FragmentViewPages496#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages496 extends Fragment {
    ...
    public static FragmentViewPages496 newInstance(String param1, String param2) {
        FragmentViewPages496 fragment = new FragmentViewPages496();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page496, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page496);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear496);
