 ...
 * Use the {@link FragmentViewPages343#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages343 extends Fragment {
    ...
    public static FragmentViewPages343 newInstance(String param1, String param2) {
        FragmentViewPages343 fragment = new FragmentViewPages343();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page343, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page343);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear343);
