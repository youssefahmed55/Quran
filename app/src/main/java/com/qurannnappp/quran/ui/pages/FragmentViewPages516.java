 ...
 * Use the {@link FragmentViewPages516#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages516 extends Fragment {
    ...
    public static FragmentViewPages516 newInstance(String param1, String param2) {
        FragmentViewPages516 fragment = new FragmentViewPages516();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page516, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page516);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear516);
