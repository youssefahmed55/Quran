 ...
 * Use the {@link FragmentViewPages459#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages459 extends Fragment {
    ...
    public static FragmentViewPages459 newInstance(String param1, String param2) {
        FragmentViewPages459 fragment = new FragmentViewPages459();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page459, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page459);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear459);
