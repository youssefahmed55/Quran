 ...
 * Use the {@link FragmentViewPages328#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages328 extends Fragment {
    ...
    public static FragmentViewPages328 newInstance(String param1, String param2) {
        FragmentViewPages328 fragment = new FragmentViewPages328();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page328, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page328);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear328);
