 ...
 * Use the {@link FragmentViewPages476#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages476 extends Fragment {
    ...
    public static FragmentViewPages476 newInstance(String param1, String param2) {
        FragmentViewPages476 fragment = new FragmentViewPages476();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page476, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page476);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear476);
