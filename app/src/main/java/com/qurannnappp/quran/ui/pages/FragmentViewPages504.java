 ...
 * Use the {@link FragmentViewPages504#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages504 extends Fragment {
    ...
    public static FragmentViewPages504 newInstance(String param1, String param2) {
        FragmentViewPages504 fragment = new FragmentViewPages504();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page504, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page504);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear504);
