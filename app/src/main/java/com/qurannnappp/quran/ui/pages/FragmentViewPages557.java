 ...
 * Use the {@link FragmentViewPages557#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages557 extends Fragment {
    ...
    public static FragmentViewPages557 newInstance(String param1, String param2) {
        FragmentViewPages557 fragment = new FragmentViewPages557();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page557, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page557);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear557);
