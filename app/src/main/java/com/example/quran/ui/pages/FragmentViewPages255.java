 ...
 * Use the {@link FragmentViewPages255#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages255 extends Fragment {
    ...
    public static FragmentViewPages255 newInstance(String param1, String param2) {
        FragmentViewPages255 fragment = new FragmentViewPages255();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page255, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear255);
        linearLayout2 = viewGroup.findViewById(R.id.linear255_2);
        s = getActivity().getResources().getString(R.string.page255);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page255_2);
        views.clear();
