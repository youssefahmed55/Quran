 ...
 * Use the {@link FragmentViewPages201#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages201 extends Fragment {
    ...
    public static FragmentViewPages201 newInstance(String param1, String param2) {
        FragmentViewPages201 fragment = new FragmentViewPages201();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page201, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page201);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear201);
