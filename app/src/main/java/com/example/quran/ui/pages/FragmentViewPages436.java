 ...
 * Use the {@link FragmentViewPages436#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages436 extends Fragment {
    ...
    public static FragmentViewPages436 newInstance(String param1, String param2) {
        FragmentViewPages436 fragment = new FragmentViewPages436();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page436, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page436);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear436);
