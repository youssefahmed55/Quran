 ...
 * Use the {@link FragmentViewPages454#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages454 extends Fragment {
    ...
    public static FragmentViewPages454 newInstance(String param1, String param2) {
        FragmentViewPages454 fragment = new FragmentViewPages454();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page454, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page454);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear454);
