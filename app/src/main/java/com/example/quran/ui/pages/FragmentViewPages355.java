 ...
 * Use the {@link FragmentViewPages355#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages355 extends Fragment {
    ...
    public static FragmentViewPages355 newInstance(String param1, String param2) {
        FragmentViewPages355 fragment = new FragmentViewPages355();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page355, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page355);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear355);
