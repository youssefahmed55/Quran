 ...
 * Use the {@link FragmentViewPages259#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages259 extends Fragment {
    ...
    public static FragmentViewPages259 newInstance(String param1, String param2) {
        FragmentViewPages259 fragment = new FragmentViewPages259();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page259, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page259);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear259);
