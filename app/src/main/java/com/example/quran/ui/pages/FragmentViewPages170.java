 ...
 * Use the {@link FragmentViewPages170#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages170 extends Fragment {
    ...
    public static FragmentViewPages170 newInstance(String param1, String param2) {
        FragmentViewPages170 fragment = new FragmentViewPages170();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page170, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page170);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear170);
