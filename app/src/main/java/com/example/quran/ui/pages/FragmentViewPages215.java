 ...
 * Use the {@link FragmentViewPages215#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages215 extends Fragment {
    ...
    public static FragmentViewPages215 newInstance(String param1, String param2) {
        FragmentViewPages215 fragment = new FragmentViewPages215();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page215, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page215);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear215);
