 ...
 * Use the {@link FragmentViewPages142#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages142 extends Fragment {
    ...
    public static FragmentViewPages142 newInstance(String param1, String param2) {
        FragmentViewPages142 fragment = new FragmentViewPages142();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page142, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page142);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear142);
