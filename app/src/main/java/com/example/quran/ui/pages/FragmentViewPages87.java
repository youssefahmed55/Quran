 ...
 * Use the {@link FragmentViewPages87#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages87 extends Fragment {
    ...
    public static FragmentViewPages87 newInstance(String param1, String param2) {
        FragmentViewPages87 fragment = new FragmentViewPages87();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page87, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page87);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear87);
