 ...
 * Use the {@link FragmentViewPages417#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages417 extends Fragment {
    ...
    public static FragmentViewPages417 newInstance(String param1, String param2) {
        FragmentViewPages417 fragment = new FragmentViewPages417();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page417, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page417);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear417);
