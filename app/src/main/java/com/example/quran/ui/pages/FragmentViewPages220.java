 ...
 * Use the {@link FragmentViewPages220#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages220 extends Fragment {
    ...
    public static FragmentViewPages220 newInstance(String param1, String param2) {
        FragmentViewPages220 fragment = new FragmentViewPages220();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page220, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page220);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear220);
