 ...
 * Use the {@link FragmentViewPages227#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages227 extends Fragment {
    ...
    public static FragmentViewPages227 newInstance(String param1, String param2) {
        FragmentViewPages227 fragment = new FragmentViewPages227();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page227, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page227);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear227);
