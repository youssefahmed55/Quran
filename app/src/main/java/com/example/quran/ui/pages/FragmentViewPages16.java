 ...
 * Use the {@link FragmentViewPages16#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages16 extends Fragment {
    ...
    public static FragmentViewPages16 newInstance(String param1, String param2) {
        FragmentViewPages16 fragment = new FragmentViewPages16();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page16, container, false);
        handleViews();
        return viewGroup;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page16);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear16);
