 ...
 * Use the {@link FragmentViewPages226#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages226 extends Fragment {
    ...
    public static FragmentViewPages226 newInstance(String param1, String param2) {
        FragmentViewPages226 fragment = new FragmentViewPages226();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page226, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page226);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear226);
