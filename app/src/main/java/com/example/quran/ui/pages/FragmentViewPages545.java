 ...
 * Use the {@link FragmentViewPages545#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages545 extends Fragment {
    ...
    public static FragmentViewPages545 newInstance(String param1, String param2) {
        FragmentViewPages545 fragment = new FragmentViewPages545();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page545, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear545);
        linearLayout2 = viewGroup.findViewById(R.id.linear545_2);
        s = getActivity().getResources().getString(R.string.page545);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page545_2);
        views.clear();
