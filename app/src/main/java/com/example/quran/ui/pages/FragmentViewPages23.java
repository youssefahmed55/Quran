 ...
 * Use the {@link FragmentViewPages23#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages23 extends Fragment {
    ...
    public static FragmentViewPages23 newInstance(String param1, String param2) {
        FragmentViewPages23 fragment = new FragmentViewPages23();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page23, container, false);
        handleViews();
        return viewGroup;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page23);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear23);
