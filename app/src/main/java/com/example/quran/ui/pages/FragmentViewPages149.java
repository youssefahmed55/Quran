 ...
 * Use the {@link FragmentViewPages149#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages149 extends Fragment {
    ...
    public static FragmentViewPages149 newInstance(String param1, String param2) {
        FragmentViewPages149 fragment = new FragmentViewPages149();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page149, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page149);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear149);
