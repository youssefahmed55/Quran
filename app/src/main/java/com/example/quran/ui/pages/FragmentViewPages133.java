 ...
 * Use the {@link FragmentViewPages133#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages133 extends Fragment {
    ...
    public static FragmentViewPages133 newInstance(String param1, String param2) {
        FragmentViewPages133 fragment = new FragmentViewPages133();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page133, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page133);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear133);
