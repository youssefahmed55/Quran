 ...
 * Use the {@link FragmentViewPages34#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages34 extends Fragment {
    ...
    public static FragmentViewPages34 newInstance(String param1, String param2) {
        FragmentViewPages34 fragment = new FragmentViewPages34();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page34, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page34);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear34);
