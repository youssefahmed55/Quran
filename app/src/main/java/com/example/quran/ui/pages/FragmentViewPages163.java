 ...
 * Use the {@link FragmentViewPages163#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages163 extends Fragment {
    ...
    public static FragmentViewPages163 newInstance(String param1, String param2) {
        FragmentViewPages163 fragment = new FragmentViewPages163();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page163, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page163);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear163);
