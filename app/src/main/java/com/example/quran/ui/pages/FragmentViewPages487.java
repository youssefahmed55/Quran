 ...
 * Use the {@link FragmentViewPages487#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages487 extends Fragment {
    ...
    public static FragmentViewPages487 newInstance(String param1, String param2) {
        FragmentViewPages487 fragment = new FragmentViewPages487();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page487, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page487);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear487);
