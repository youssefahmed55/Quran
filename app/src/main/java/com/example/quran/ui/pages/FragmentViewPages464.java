 ...
 * Use the {@link FragmentViewPages464#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages464 extends Fragment {
    ...
    public static FragmentViewPages464 newInstance(String param1, String param2) {
        FragmentViewPages464 fragment = new FragmentViewPages464();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page464, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page464);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear464);
