 ...
 * Use the {@link FragmentViewPages117#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages117 extends Fragment {
    ...
    public static FragmentViewPages117 newInstance(String param1, String param2) {
        FragmentViewPages117 fragment = new FragmentViewPages117();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page117, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page117);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear117);
