 ...
 * Use the {@link FragmentViewPages242#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages242 extends Fragment {
    ...
    public static FragmentViewPages242 newInstance(String param1, String param2) {
        FragmentViewPages242 fragment = new FragmentViewPages242();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page242, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page242);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear242);
