 ...
 * Use the {@link FragmentViewPages120#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages120 extends Fragment {
    ...
    public static FragmentViewPages120 newInstance(String param1, String param2) {
        FragmentViewPages120 fragment = new FragmentViewPages120();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page120, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page120);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear120);
