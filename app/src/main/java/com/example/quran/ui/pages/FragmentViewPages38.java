 ...
 * Use the {@link FragmentViewPages38#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages38 extends Fragment {
    ...
    public static FragmentViewPages38 newInstance(String param1, String param2) {
        FragmentViewPages38 fragment = new FragmentViewPages38();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page38, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page38);
        ...
        for (String word : s.split(" ")){
            ...
            switch (i){
                case 25 :
                    ...
                    imageView.setImageResource(R.drawable.num234);
                    views.add(imageView);
                    break;
                case 72 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num235);
                    views.add(imageView);
                    break;
                case 97 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num236);
                    views.add(imageView);
                    break;
                case 132 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num237);
                    views.add(imageView);
                    break;
        ...
        linearLayout = viewGroup.findViewById(R.id.linear38);
