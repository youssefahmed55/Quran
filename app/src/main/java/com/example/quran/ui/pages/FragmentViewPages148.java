 ...
 * Use the {@link FragmentViewPages148#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages148 extends Fragment {
    ...
    public static FragmentViewPages148 newInstance(String param1, String param2) {
        FragmentViewPages148 fragment = new FragmentViewPages148();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page148, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page148);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear148);
