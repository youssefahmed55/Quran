 ...
 * Use the {@link FragmentViewPages430#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages430 extends Fragment {
    ...
    public static FragmentViewPages430 newInstance(String param1, String param2) {
        FragmentViewPages430 fragment = new FragmentViewPages430();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page430, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page430);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear430);
