 ...
 * Use the {@link FragmentViewPages553#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages553 extends Fragment {
    ...
    public static FragmentViewPages553 newInstance(String param1, String param2) {
        FragmentViewPages553 fragment = new FragmentViewPages553();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page553, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page553);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear553);
