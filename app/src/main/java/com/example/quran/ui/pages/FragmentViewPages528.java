 ...
 * Use the {@link FragmentViewPages528#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages528 extends Fragment {
    ...
    public static FragmentViewPages528 newInstance(String param1, String param2) {
        FragmentViewPages528 fragment = new FragmentViewPages528();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page528, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear528);
        linearLayout2 = viewGroup.findViewById(R.id.linear528_2);
        s = getActivity().getResources().getString(R.string.page528);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page528_2);
        views.clear();
