 ...
 * Use the {@link FragmentViewPages535#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages535 extends Fragment {
    ...
    public static FragmentViewPages535 newInstance(String param1, String param2) {
        FragmentViewPages535 fragment = new FragmentViewPages535();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page535, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page535);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear535);
