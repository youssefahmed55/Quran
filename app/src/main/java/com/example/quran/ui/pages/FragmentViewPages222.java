 ...
 * Use the {@link FragmentViewPages222#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages222 extends Fragment {
    ...
    public static FragmentViewPages222 newInstance(String param1, String param2) {
        FragmentViewPages222 fragment = new FragmentViewPages222();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page222, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page222);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear222);
