 ...
 * Use the {@link FragmentViewPages329#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages329 extends Fragment {
    ...
    public static FragmentViewPages329 newInstance(String param1, String param2) {
        FragmentViewPages329 fragment = new FragmentViewPages329();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page329, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page329);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear329);
