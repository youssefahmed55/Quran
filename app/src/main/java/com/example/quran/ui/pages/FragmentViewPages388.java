 ...
 * Use the {@link FragmentViewPages388#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages388 extends Fragment {
    ...
    public static FragmentViewPages388 newInstance(String param1, String param2) {
        FragmentViewPages388 fragment = new FragmentViewPages388();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page388, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page388);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear388);
