 ...
 * Use the {@link FragmentViewPages374#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages374 extends Fragment {
    ...
    public static FragmentViewPages374 newInstance(String param1, String param2) {
        FragmentViewPages374 fragment = new FragmentViewPages374();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page374, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page374);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear374);
