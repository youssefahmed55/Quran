 ...
 * Use the {@link FragmentViewPages457#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages457 extends Fragment {
    ...
    public static FragmentViewPages457 newInstance(String param1, String param2) {
        FragmentViewPages457 fragment = new FragmentViewPages457();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page457, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page457);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear457);
