 ...
 * Use the {@link FragmentViewPages541#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages541 extends Fragment {
    ...
    public static FragmentViewPages541 newInstance(String param1, String param2) {
        FragmentViewPages541 fragment = new FragmentViewPages541();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page541, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page541);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear541);
