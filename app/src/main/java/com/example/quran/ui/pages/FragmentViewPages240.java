 ...
 * Use the {@link FragmentViewPages240#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages240 extends Fragment {
    ...
    public static FragmentViewPages240 newInstance(String param1, String param2) {
        FragmentViewPages240 fragment = new FragmentViewPages240();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page240, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page240);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear240);
