 ...
 * Use the {@link FragmentViewPages399#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages399 extends Fragment {
    ...
    public static FragmentViewPages399 newInstance(String param1, String param2) {
        FragmentViewPages399 fragment = new FragmentViewPages399();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page399, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page399);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear399);
