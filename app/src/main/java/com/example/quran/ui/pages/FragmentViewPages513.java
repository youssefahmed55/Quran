 ...
 * Use the {@link FragmentViewPages513#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages513 extends Fragment {
    ...
    public static FragmentViewPages513 newInstance(String param1, String param2) {
        FragmentViewPages513 fragment = new FragmentViewPages513();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page513, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page513);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear513);
