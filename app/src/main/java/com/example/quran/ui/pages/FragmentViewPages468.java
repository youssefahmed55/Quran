 ...
 * Use the {@link FragmentViewPages468#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages468 extends Fragment {
    ...
    public static FragmentViewPages468 newInstance(String param1, String param2) {
        FragmentViewPages468 fragment = new FragmentViewPages468();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page468, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page468);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear468);
