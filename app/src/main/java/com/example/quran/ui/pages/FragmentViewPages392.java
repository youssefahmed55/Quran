 ...
 * Use the {@link FragmentViewPages392#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages392 extends Fragment {
    ...
    public static FragmentViewPages392 newInstance(String param1, String param2) {
        FragmentViewPages392 fragment = new FragmentViewPages392();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page392, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page392);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear392);
