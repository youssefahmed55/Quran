 ...
 * Use the {@link FragmentViewPages502#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages502 extends Fragment {
    ...
    public static FragmentViewPages502 newInstance(String param1, String param2) {
        FragmentViewPages502 fragment = new FragmentViewPages502();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page502, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear502);
        linearLayout2 = viewGroup.findViewById(R.id.linear502_2);
        s = getActivity().getResources().getString(R.string.page502);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page502_2);
        views.clear();
