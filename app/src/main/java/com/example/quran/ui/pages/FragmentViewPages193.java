 ...
 * Use the {@link FragmentViewPages193#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages193 extends Fragment {
    ...
    public static FragmentViewPages193 newInstance(String param1, String param2) {
        FragmentViewPages193 fragment = new FragmentViewPages193();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page193, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page193);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear193);
