 ...
 * Use the {@link FragmentViewPages354#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages354 extends Fragment {
    ...
    public static FragmentViewPages354 newInstance(String param1, String param2) {
        FragmentViewPages354 fragment = new FragmentViewPages354();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page354, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page354);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear354);
