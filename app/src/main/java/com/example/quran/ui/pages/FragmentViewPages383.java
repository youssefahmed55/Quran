 ...
 * Use the {@link FragmentViewPages383#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages383 extends Fragment {
    ...
    public static FragmentViewPages383 newInstance(String param1, String param2) {
        FragmentViewPages383 fragment = new FragmentViewPages383();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page383, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page383);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear383);
