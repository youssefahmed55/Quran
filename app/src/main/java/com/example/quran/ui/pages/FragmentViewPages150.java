 ...
 * Use the {@link FragmentViewPages150#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages150 extends Fragment {
    ...
    public static FragmentViewPages150 newInstance(String param1, String param2) {
        FragmentViewPages150 fragment = new FragmentViewPages150();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page150, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page150);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear150);
