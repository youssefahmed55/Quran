 ...
 * Use the {@link FragmentViewPages49#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages49 extends Fragment {
    ...
    public static FragmentViewPages49 newInstance(String param1, String param2) {
        FragmentViewPages49 fragment = new FragmentViewPages49();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page49, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page49);
        ...
        for (String word : s.split(" ")){
            ...
            switch (i){
                case 32 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num283);
                    views.add(imageView);
                    break;
                case 60 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num284);
                    views.add(imageView);
                    break;
                case 87 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num285);
                    views.add(imageView);
                    break;
                case 136 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num286);
                    views.add(imageView);
                    break;
        ...
        linearLayout = viewGroup.findViewById(R.id.linear49);
