 ...
 * Use the {@link FragmentViewPages194#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages194 extends Fragment {
    ...
    public static FragmentViewPages194 newInstance(String param1, String param2) {
        FragmentViewPages194 fragment = new FragmentViewPages194();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page194, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page194);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear194);
