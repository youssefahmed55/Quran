 ...
 * Use the {@link FragmentViewPages571#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages571 extends Fragment {
    ...
    public static FragmentViewPages571 newInstance(String param1, String param2) {
        FragmentViewPages571 fragment = new FragmentViewPages571();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page571, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page571);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear571);
