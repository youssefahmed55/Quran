 ...
 * Use the {@link FragmentViewPages514#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages514 extends Fragment {
    ...
    public static FragmentViewPages514 newInstance(String param1, String param2) {
        FragmentViewPages514 fragment = new FragmentViewPages514();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page514, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page514);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear514);
