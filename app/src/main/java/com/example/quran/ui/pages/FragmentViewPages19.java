 ...
 * Use the {@link FragmentViewPages19#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages19 extends Fragment {
    ...
    public static FragmentViewPages19 newInstance(String param1, String param2) {
        FragmentViewPages19 fragment = new FragmentViewPages19();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page19, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page19);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear19);
