 ...
 * Use the {@link FragmentViewPages444#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages444 extends Fragment {
    ...
    public static FragmentViewPages444 newInstance(String param1, String param2) {
        FragmentViewPages444 fragment = new FragmentViewPages444();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page444, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page444);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear444);
