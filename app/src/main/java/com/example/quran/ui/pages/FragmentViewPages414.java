 ...
 * Use the {@link FragmentViewPages414#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages414 extends Fragment {
    ...
    public static FragmentViewPages414 newInstance(String param1, String param2) {
        FragmentViewPages414 fragment = new FragmentViewPages414();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page414, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page414);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear414);
