 ...
 * Use the {@link FragmentViewPages565#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages565 extends Fragment {
    ...
    public static FragmentViewPages565 newInstance(String param1, String param2) {
        FragmentViewPages565 fragment = new FragmentViewPages565();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page565, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page565);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear565);
