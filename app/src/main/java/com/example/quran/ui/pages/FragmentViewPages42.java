 ...
 * Use the {@link FragmentViewPages42#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages42 extends Fragment {
    ...
    public static FragmentViewPages42 newInstance(String param1, String param2) {
        FragmentViewPages42 fragment = new FragmentViewPages42();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page42, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page42);
        ...
        for (String word : s.split(" ")){
            ...
            switch (i){
                case 52 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num253);
                    views.add(imageView);
                    break;
                case 74 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num254);
                    views.add(imageView);
                    break;
                case 124 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num255);
                    views.add(imageView);
                    break;
                case 148 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num256);
                    views.add(imageView);
                    break;
            }
        ...
        linearLayout = viewGroup.findViewById(R.id.linear42);
