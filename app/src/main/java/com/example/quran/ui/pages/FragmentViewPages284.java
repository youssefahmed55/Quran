 ...
 * Use the {@link FragmentViewPages284#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages284 extends Fragment {
    ...
    public static FragmentViewPages284 newInstance(String param1, String param2) {
        FragmentViewPages284 fragment = new FragmentViewPages284();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page284, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page284);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear284);
