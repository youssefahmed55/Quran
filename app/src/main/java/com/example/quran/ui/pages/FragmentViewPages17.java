 ...
 * Use the {@link FragmentViewPages17#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages17 extends Fragment {
    ...
    public static FragmentViewPages17 newInstance(String param1, String param2) {
        FragmentViewPages17 fragment = new FragmentViewPages17();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page17, container, false);
        handleViews();
        return viewGroup;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page17);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear17);
