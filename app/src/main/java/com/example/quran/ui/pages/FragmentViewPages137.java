 ...
 * Use the {@link FragmentViewPages137#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages137 extends Fragment {
    ...
    public static FragmentViewPages137 newInstance(String param1, String param2) {
        FragmentViewPages137 fragment = new FragmentViewPages137();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page137, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page137);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear137);
