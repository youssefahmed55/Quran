 ...
 * Use the {@link FragmentViewPages492#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages492 extends Fragment {
    ...
    public static FragmentViewPages492 newInstance(String param1, String param2) {
        FragmentViewPages492 fragment = new FragmentViewPages492();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page492, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page492);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear492);
