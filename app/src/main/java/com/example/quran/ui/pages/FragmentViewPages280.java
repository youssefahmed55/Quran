 ...
 * Use the {@link FragmentViewPages280#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages280 extends Fragment {
    ...
    public static FragmentViewPages280 newInstance(String param1, String param2) {
        FragmentViewPages280 fragment = new FragmentViewPages280();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page280, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page280);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear280);
