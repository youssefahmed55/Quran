 ...
 * Use the {@link FragmentViewPages413#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages413 extends Fragment {
    ...
    public static FragmentViewPages413 newInstance(String param1, String param2) {
        FragmentViewPages413 fragment = new FragmentViewPages413();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page413, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page413);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear413);
