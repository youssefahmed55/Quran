 ...
 * Use the {@link FragmentViewPages310#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages310 extends Fragment {
    ...
    public static FragmentViewPages310 newInstance(String param1, String param2) {
        FragmentViewPages310 fragment = new FragmentViewPages310();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page310, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page310);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear310);
