 ...
 * Use the {@link FragmentViewPages28#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages28 extends Fragment {
    ...
    public static FragmentViewPages28 newInstance(String param1, String param2) {
        FragmentViewPages28 fragment = new FragmentViewPages28();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page28, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page28);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear28);
