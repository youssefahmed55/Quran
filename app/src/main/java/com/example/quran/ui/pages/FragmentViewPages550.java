 ...
 * Use the {@link FragmentViewPages550#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages550 extends Fragment {
    ...
    public static FragmentViewPages550 newInstance(String param1, String param2) {
        FragmentViewPages550 fragment = new FragmentViewPages550();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page550, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page550);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear550);
