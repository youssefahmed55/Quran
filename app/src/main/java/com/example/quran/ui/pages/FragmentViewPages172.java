 ...
 * Use the {@link FragmentViewPages172#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages172 extends Fragment {
    ...
    public static FragmentViewPages172 newInstance(String param1, String param2) {
        FragmentViewPages172 fragment = new FragmentViewPages172();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page172, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page172);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear172);
