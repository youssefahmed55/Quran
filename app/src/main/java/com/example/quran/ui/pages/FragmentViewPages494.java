 ...
 * Use the {@link FragmentViewPages494#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages494 extends Fragment {
    ...
    public static FragmentViewPages494 newInstance(String param1, String param2) {
        FragmentViewPages494 fragment = new FragmentViewPages494();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page494, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page494);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear494);
