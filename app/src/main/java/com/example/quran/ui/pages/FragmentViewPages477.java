 ...
 * Use the {@link FragmentViewPages477#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages477 extends Fragment {
    ...
    public static FragmentViewPages477 newInstance(String param1, String param2) {
        FragmentViewPages477 fragment = new FragmentViewPages477();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page477, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page477);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear477);
