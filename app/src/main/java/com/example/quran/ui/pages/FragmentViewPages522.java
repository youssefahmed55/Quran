 ...
 * Use the {@link FragmentViewPages522#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages522 extends Fragment {
    ...
    public static FragmentViewPages522 newInstance(String param1, String param2) {
        FragmentViewPages522 fragment = new FragmentViewPages522();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page522, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page522);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear522);
