 ...
 * Use the {@link FragmentViewPages179#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages179 extends Fragment {
    ...
    public static FragmentViewPages179 newInstance(String param1, String param2) {
        FragmentViewPages179 fragment = new FragmentViewPages179();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page179, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page179);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear179);
