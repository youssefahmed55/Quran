 ...
 * Use the {@link FragmentViewPages231#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages231 extends Fragment {
    ...
    public static FragmentViewPages231 newInstance(String param1, String param2) {
        FragmentViewPages231 fragment = new FragmentViewPages231();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page231, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page231);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear231);
