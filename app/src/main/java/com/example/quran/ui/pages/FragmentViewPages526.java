 ...
 * Use the {@link FragmentViewPages526#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages526 extends Fragment {
    ...
    public static FragmentViewPages526 newInstance(String param1, String param2) {
        FragmentViewPages526 fragment = new FragmentViewPages526();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page526, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page526);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear526);
