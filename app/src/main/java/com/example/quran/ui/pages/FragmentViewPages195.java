 ...
 * Use the {@link FragmentViewPages195#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages195 extends Fragment {
    ...
    public static FragmentViewPages195 newInstance(String param1, String param2) {
        FragmentViewPages195 fragment = new FragmentViewPages195();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page195, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page195);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear195);
