 ...
 * Use the {@link FragmentViewPages590#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages590 extends Fragment {
    ...
    public static FragmentViewPages590 newInstance(String param1, String param2) {
        FragmentViewPages590 fragment = new FragmentViewPages590();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page590, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page590);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear590);
