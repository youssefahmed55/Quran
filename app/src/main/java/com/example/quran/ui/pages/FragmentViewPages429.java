 ...
 * Use the {@link FragmentViewPages429#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages429 extends Fragment {
    ...
    public static FragmentViewPages429 newInstance(String param1, String param2) {
        FragmentViewPages429 fragment = new FragmentViewPages429();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page429, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page429);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear429);
