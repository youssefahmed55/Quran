 ...
 * Use the {@link FragmentViewPages549#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages549 extends Fragment {
    ...
    public static FragmentViewPages549 newInstance(String param1, String param2) {
        FragmentViewPages549 fragment = new FragmentViewPages549();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page549, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page549);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear549);
