 ...
 * Use the {@link FragmentViewPages151#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages151 extends Fragment {
    ...
    public static FragmentViewPages151 newInstance(String param1, String param2) {
        FragmentViewPages151 fragment = new FragmentViewPages151();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page151, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page151);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear151);
