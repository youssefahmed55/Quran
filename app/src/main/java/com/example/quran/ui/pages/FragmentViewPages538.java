 ...
 * Use the {@link FragmentViewPages538#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages538 extends Fragment {
    ...
    public static FragmentViewPages538 newInstance(String param1, String param2) {
        FragmentViewPages538 fragment = new FragmentViewPages538();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page538, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page538);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear538);
