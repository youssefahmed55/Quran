 ...
 * Use the {@link FragmentViewPages82#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages82 extends Fragment {
    ...
    public static FragmentViewPages82 newInstance(String param1, String param2) {
        FragmentViewPages82 fragment = new FragmentViewPages82();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page82, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page82);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear82);
