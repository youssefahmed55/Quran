 ...
 * Use the {@link FragmentViewPages517#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages517 extends Fragment {
    ...
    public static FragmentViewPages517 newInstance(String param1, String param2) {
        FragmentViewPages517 fragment = new FragmentViewPages517();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page517, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page517);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear517);
