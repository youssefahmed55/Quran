 ...
 * Use the {@link FragmentViewPages508#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages508 extends Fragment {
    ...
    public static FragmentViewPages508 newInstance(String param1, String param2) {
        FragmentViewPages508 fragment = new FragmentViewPages508();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page508, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page508);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear508);
