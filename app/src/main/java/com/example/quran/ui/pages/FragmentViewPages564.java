 ...
 * Use the {@link FragmentViewPages564#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages564 extends Fragment {
    ...
    public static FragmentViewPages564 newInstance(String param1, String param2) {
        FragmentViewPages564 fragment = new FragmentViewPages564();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page564, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear564);
        linearLayout2 = viewGroup.findViewById(R.id.linear564_2);
        s = getActivity().getResources().getString(R.string.page564);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page564_2);
        views.clear();
