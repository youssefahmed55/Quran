 ...
 * Use the {@link FragmentViewPages314#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages314 extends Fragment {
    ...
    public static FragmentViewPages314 newInstance(String param1, String param2) {
        FragmentViewPages314 fragment = new FragmentViewPages314();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page314, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page314);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear314);
