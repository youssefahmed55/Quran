 ...
 * Use the {@link FragmentViewPages84#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages84 extends Fragment {
    ...
    public static FragmentViewPages84 newInstance(String param1, String param2) {
        FragmentViewPages84 fragment = new FragmentViewPages84();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page84, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page84);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear84);
