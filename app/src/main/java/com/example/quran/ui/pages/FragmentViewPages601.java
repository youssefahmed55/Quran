 ...
 * Use the {@link FragmentViewPages601#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages601 extends Fragment {
    ...
    public static FragmentViewPages601 newInstance(String param1, String param2) {
        FragmentViewPages601 fragment = new FragmentViewPages601();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page601, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear601);
        linearLayout2 = viewGroup.findViewById(R.id.linear601_2);
        linearLayout3 = viewGroup.findViewById(R.id.linear601_3);

        s = getActivity().getResources().getString(R.string.page601);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page601_2);
        views.clear();
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page601_3);
        views.clear();
