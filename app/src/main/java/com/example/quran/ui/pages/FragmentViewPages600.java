 ...
 * Use the {@link FragmentViewPages600#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages600 extends Fragment {
    ...
    public static FragmentViewPages600 newInstance(String param1, String param2) {
        FragmentViewPages600 fragment = new FragmentViewPages600();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page600, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear600);
        linearLayout2 = viewGroup.findViewById(R.id.linear600_2);
        linearLayout3 = viewGroup.findViewById(R.id.linear600_3);

        s = getActivity().getResources().getString(R.string.page600);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page600_2);
        views.clear();
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page600_3);
        views.clear();
