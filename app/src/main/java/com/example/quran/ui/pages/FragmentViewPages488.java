 ...
 * Use the {@link FragmentViewPages488#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages488 extends Fragment {
    ...
    public static FragmentViewPages488 newInstance(String param1, String param2) {
        FragmentViewPages488 fragment = new FragmentViewPages488();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page488, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page488);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear488);
