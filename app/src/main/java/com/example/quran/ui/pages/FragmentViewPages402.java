 ...
 * Use the {@link FragmentViewPages402#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages402 extends Fragment {
    ...
    public static FragmentViewPages402 newInstance(String param1, String param2) {
        FragmentViewPages402 fragment = new FragmentViewPages402();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page402, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page402);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear402);
