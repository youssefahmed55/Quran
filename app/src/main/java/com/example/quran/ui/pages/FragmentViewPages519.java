 ...
 * Use the {@link FragmentViewPages519#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages519 extends Fragment {
    ...
    public static FragmentViewPages519 newInstance(String param1, String param2) {
        FragmentViewPages519 fragment = new FragmentViewPages519();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page519, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page519);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear519);
