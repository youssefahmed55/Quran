 ...
 * Use the {@link FragmentViewPages484#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages484 extends Fragment {
    ...
    public static FragmentViewPages484 newInstance(String param1, String param2) {
        FragmentViewPages484 fragment = new FragmentViewPages484();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page484, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page484);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear484);
