 ...
 * Use the {@link FragmentViewPages73#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages73 extends Fragment {
    ...
    public static FragmentViewPages73 newInstance(String param1, String param2) {
        FragmentViewPages73 fragment = new FragmentViewPages73();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page73, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page73);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear73);
