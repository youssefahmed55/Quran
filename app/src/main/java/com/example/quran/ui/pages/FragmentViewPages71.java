 ...
 * Use the {@link FragmentViewPages71#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages71 extends Fragment {
    ...
    public static FragmentViewPages71 newInstance(String param1, String param2) {
        FragmentViewPages71 fragment = new FragmentViewPages71();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page71, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page71);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear71);
