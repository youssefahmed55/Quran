 ...
 * Use the {@link FragmentViewPages572#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages572 extends Fragment {
    ...
    public static FragmentViewPages572 newInstance(String param1, String param2) {
        FragmentViewPages572 fragment = new FragmentViewPages572();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page572, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page572);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear572);
