 ...
 * Use the {@link FragmentViewPages267#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages267 extends Fragment {
    ...
    public static FragmentViewPages267 newInstance(String param1, String param2) {
        FragmentViewPages267 fragment = new FragmentViewPages267();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page267, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear267);
        linearLayout2 = viewGroup.findViewById(R.id.linear267_2);
        s = getActivity().getResources().getString(R.string.page267);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page267_2);
        views.clear();
