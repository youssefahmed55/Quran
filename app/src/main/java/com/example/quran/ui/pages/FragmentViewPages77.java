 ...
 * Use the {@link FragmentViewPages77#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages77 extends Fragment {
    ...
    public static FragmentViewPages77 newInstance(String param1, String param2) {
        FragmentViewPages77 fragment = new FragmentViewPages77();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page77, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page77);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear77);
