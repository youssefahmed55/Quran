 ...
 * Use the {@link FragmentViewPages551#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages551 extends Fragment {
    ...
    public static FragmentViewPages551 newInstance(String param1, String param2) {
        FragmentViewPages551 fragment = new FragmentViewPages551();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page551, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear551);
        linearLayout2 = viewGroup.findViewById(R.id.linear551_2);
        s = getActivity().getResources().getString(R.string.page551);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page551_2);
        views.clear();
