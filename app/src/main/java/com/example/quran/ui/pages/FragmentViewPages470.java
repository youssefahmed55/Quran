 ...
 * Use the {@link FragmentViewPages470#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages470 extends Fragment {
    ...
    public static FragmentViewPages470 newInstance(String param1, String param2) {
        FragmentViewPages470 fragment = new FragmentViewPages470();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page470, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page470);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear470);
