 ...
 * Use the {@link FragmentViewPages285#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages285 extends Fragment {
    ...
    public static FragmentViewPages285 newInstance(String param1, String param2) {
        FragmentViewPages285 fragment = new FragmentViewPages285();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page285, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page285);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear285);
