 ...
 * Use the {@link FragmentViewPages245#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages245 extends Fragment {
    ...
    public static FragmentViewPages245 newInstance(String param1, String param2) {
        FragmentViewPages245 fragment = new FragmentViewPages245();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page245, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page245);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear245);
