 ...
 * Use the {@link FragmentViewPages268#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages268 extends Fragment {
    ...
    public static FragmentViewPages268 newInstance(String param1, String param2) {
        FragmentViewPages268 fragment = new FragmentViewPages268();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page268, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page268);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear268);
