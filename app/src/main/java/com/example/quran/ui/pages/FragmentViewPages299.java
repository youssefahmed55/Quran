 ...
 * Use the {@link FragmentViewPages299#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages299 extends Fragment {
    ...
    public static FragmentViewPages299 newInstance(String param1, String param2) {
        FragmentViewPages299 fragment = new FragmentViewPages299();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page299, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page299);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear299);
