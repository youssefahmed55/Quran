 ...
 * Use the {@link FragmentViewPages530#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages530 extends Fragment {
    ...
    public static FragmentViewPages530 newInstance(String param1, String param2) {
        FragmentViewPages530 fragment = new FragmentViewPages530();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page530, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page530);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear530);
