 ...
 * Use the {@link FragmentViewPages479#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages479 extends Fragment {
    ...
    public static FragmentViewPages479 newInstance(String param1, String param2) {
        FragmentViewPages479 fragment = new FragmentViewPages479();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page479, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page479);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear479);
