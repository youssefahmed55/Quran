 ...
 * Use the {@link FragmentViewPages41#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages41 extends Fragment {
    ...
    public static FragmentViewPages41 newInstance(String param1, String param2) {
        FragmentViewPages41 fragment = new FragmentViewPages41();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page41, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page41);
        ...
        for (String word : s.split(" ")){
            ...
            switch (i){
                case 60 :
                    ...
                    imageView.setImageResource(R.drawable.num249);
                    views.add(imageView);
                    break;
                case 75 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num250);
                    views.add(imageView);
                    break;
                case 102 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num251);
                    views.add(imageView);
                    break;
                case 111 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num252);
                    views.add(imageView);
                    break;
            }
        ...
        linearLayout = viewGroup.findViewById(R.id.linear41);
