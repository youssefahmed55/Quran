 ...
 * Use the {@link FragmentViewPages393#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages393 extends Fragment {
    ...
    public static FragmentViewPages393 newInstance(String param1, String param2) {
        FragmentViewPages393 fragment = new FragmentViewPages393();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page393, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page393);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear393);
