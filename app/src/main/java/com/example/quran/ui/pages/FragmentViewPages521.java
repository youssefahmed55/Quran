 ...
 * Use the {@link FragmentViewPages521#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages521 extends Fragment {
    ...
    public static FragmentViewPages521 newInstance(String param1, String param2) {
        FragmentViewPages521 fragment = new FragmentViewPages521();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page521, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page521);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear521);
