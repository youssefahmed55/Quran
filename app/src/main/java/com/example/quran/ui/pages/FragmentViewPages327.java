 ...
 * Use the {@link FragmentViewPages327#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages327 extends Fragment {
    ...
    public static FragmentViewPages327 newInstance(String param1, String param2) {
        FragmentViewPages327 fragment = new FragmentViewPages327();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page327, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page327);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear327);
