 ...
 * Use the {@link FragmentViewPages499#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages499 extends Fragment {
    ...
    public static FragmentViewPages499 newInstance(String param1, String param2) {
        FragmentViewPages499 fragment = new FragmentViewPages499();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page499, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page499);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear499);
