 ...
 * Use the {@link FragmentViewPages523#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages523 extends Fragment {
    ...
    public static FragmentViewPages523 newInstance(String param1, String param2) {
        FragmentViewPages523 fragment = new FragmentViewPages523();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page523, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear523);
        linearLayout2 = viewGroup.findViewById(R.id.linear523_2);
        s = getActivity().getResources().getString(R.string.page523);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page523_2);
        views.clear();
