 ...
 * Use the {@link FragmentViewPages187#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages187 extends Fragment {
    ...
    public static FragmentViewPages187 newInstance(String param1, String param2) {
        FragmentViewPages187 fragment = new FragmentViewPages187();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page187, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page187);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear187);
