 ...
 * Use the {@link FragmentViewPages10#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages10 extends Fragment {
    ...
    public static FragmentViewPages10 newInstance(String param1, String param2) {
        FragmentViewPages10 fragment = new FragmentViewPages10();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page10, container, false);
        handleViews();
        return viewGroup;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page10);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear10);
