 ...
 * Use the {@link FragmentViewPages593#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages593 extends Fragment {
    ...
    public static FragmentViewPages593 newInstance(String param1, String param2) {
        FragmentViewPages593 fragment = new FragmentViewPages593();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page593, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page593);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear593);
