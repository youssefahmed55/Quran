 ...
 * Use the {@link FragmentViewPages289#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages289 extends Fragment {
    ...
    public static FragmentViewPages289 newInstance(String param1, String param2) {
        FragmentViewPages289 fragment = new FragmentViewPages289();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page289, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page289);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear289);
