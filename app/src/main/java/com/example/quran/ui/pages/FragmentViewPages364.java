 ...
 * Use the {@link FragmentViewPages364#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages364 extends Fragment {
    ...
    public static FragmentViewPages364 newInstance(String param1, String param2) {
        FragmentViewPages364 fragment = new FragmentViewPages364();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page364, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page364);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear364);
