 ...
 * Use the {@link FragmentViewPages115#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages115 extends Fragment {
    ...
    public static FragmentViewPages115 newInstance(String param1, String param2) {
        FragmentViewPages115 fragment = new FragmentViewPages115();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page115, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page115);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear115);
