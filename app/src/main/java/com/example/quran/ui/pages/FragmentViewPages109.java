 ...
 * Use the {@link FragmentViewPages109#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages109 extends Fragment {
    ...
    public static FragmentViewPages109 newInstance(String param1, String param2) {
        FragmentViewPages109 fragment = new FragmentViewPages109();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page109, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page109);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear109);
