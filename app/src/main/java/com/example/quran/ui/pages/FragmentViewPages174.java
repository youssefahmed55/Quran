 ...
 * Use the {@link FragmentViewPages174#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages174 extends Fragment {
    ...
    public static FragmentViewPages174 newInstance(String param1, String param2) {
        FragmentViewPages174 fragment = new FragmentViewPages174();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page174, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page174);
        ...
        for (String word : s.split(" ")){
            ...
            switch (i){
                ...
                case 64 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num183);
                    views.add(imageView);
                    break;
                case 75 :
                    imageView = new ImageView(getActivity());
        ...
        linearLayout = viewGroup.findViewById(R.id.linear174);
