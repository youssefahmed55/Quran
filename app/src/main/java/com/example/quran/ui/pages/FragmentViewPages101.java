 ...
 * Use the {@link FragmentViewPages101#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages101 extends Fragment {
    ...
    public static FragmentViewPages101 newInstance(String param1, String param2) {
        FragmentViewPages101 fragment = new FragmentViewPages101();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page101, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page101);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear101);
