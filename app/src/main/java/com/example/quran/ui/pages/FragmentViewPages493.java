 ...
 * Use the {@link FragmentViewPages493#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages493 extends Fragment {
    ...
    public static FragmentViewPages493 newInstance(String param1, String param2) {
        FragmentViewPages493 fragment = new FragmentViewPages493();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page493, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page493);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear493);
