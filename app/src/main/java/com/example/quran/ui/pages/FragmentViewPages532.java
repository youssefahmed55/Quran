 ...
 * Use the {@link FragmentViewPages532#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages532 extends Fragment {
    ...
    public static FragmentViewPages532 newInstance(String param1, String param2) {
        FragmentViewPages532 fragment = new FragmentViewPages532();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page532, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page532);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear532);
