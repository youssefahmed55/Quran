 ...
 * Use the {@link FragmentViewPages112#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages112 extends Fragment {
    ...
    public static FragmentViewPages112 newInstance(String param1, String param2) {
        FragmentViewPages112 fragment = new FragmentViewPages112();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page112, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page112);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear112);
