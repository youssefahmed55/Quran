 ...
 * Use the {@link FragmentViewPages188#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages188 extends Fragment {
    ...
    public static FragmentViewPages188 newInstance(String param1, String param2) {
        FragmentViewPages188 fragment = new FragmentViewPages188();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page188, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page188);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear188);
