 ...
 * Use the {@link FragmentViewPages74#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages74 extends Fragment {
    ...
    public static FragmentViewPages74 newInstance(String param1, String param2) {
        FragmentViewPages74 fragment = new FragmentViewPages74();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page74, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page74);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear74);
