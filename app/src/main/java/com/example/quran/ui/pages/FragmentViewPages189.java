 ...
 * Use the {@link FragmentViewPages189#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages189 extends Fragment {
    ...
    public static FragmentViewPages189 newInstance(String param1, String param2) {
        FragmentViewPages189 fragment = new FragmentViewPages189();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page189, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page189);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear189);
