 ...
 * Use the {@link FragmentViewPages358#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages358 extends Fragment {
    ...
    public static FragmentViewPages358 newInstance(String param1, String param2) {
        FragmentViewPages358 fragment = new FragmentViewPages358();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page358, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page358);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear358);
