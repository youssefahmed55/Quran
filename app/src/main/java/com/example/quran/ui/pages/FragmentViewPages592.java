 ...
 * Use the {@link FragmentViewPages592#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages592 extends Fragment {
    ...
    public static FragmentViewPages592 newInstance(String param1, String param2) {
        FragmentViewPages592 fragment = new FragmentViewPages592();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page592, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear592);
        linearLayout2 = viewGroup.findViewById(R.id.linear592_2);
        s = getActivity().getResources().getString(R.string.page592);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page592_2);
        views.clear();
