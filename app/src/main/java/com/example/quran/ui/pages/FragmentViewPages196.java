 ...
 * Use the {@link FragmentViewPages196#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages196 extends Fragment {
    ...
    public static FragmentViewPages196 newInstance(String param1, String param2) {
        FragmentViewPages196 fragment = new FragmentViewPages196();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page196, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page196);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear196);
