 ...
 * Use the {@link FragmentViewPages102#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages102 extends Fragment {
    ...
    public static FragmentViewPages102 newInstance(String param1, String param2) {
        FragmentViewPages102 fragment = new FragmentViewPages102();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page102, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page102);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear102);
