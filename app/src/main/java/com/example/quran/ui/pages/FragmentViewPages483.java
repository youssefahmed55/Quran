 ...
 * Use the {@link FragmentViewPages483#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages483 extends Fragment {
    ...
    public static FragmentViewPages483 newInstance(String param1, String param2) {
        FragmentViewPages483 fragment = new FragmentViewPages483();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page483, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page483);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear483);
