 ...
 * Use the {@link FragmentViewPages105#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages105 extends Fragment {
    ...
    public static FragmentViewPages105 newInstance(String param1, String param2) {
        FragmentViewPages105 fragment = new FragmentViewPages105();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page105, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page105);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear105);
