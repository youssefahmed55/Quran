 ...
 * Use the {@link FragmentViewPages93#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages93 extends Fragment {
    ...
    public static FragmentViewPages93 newInstance(String param1, String param2) {
        FragmentViewPages93 fragment = new FragmentViewPages93();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page93, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page93);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear93);
