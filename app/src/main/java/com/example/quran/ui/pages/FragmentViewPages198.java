 ...
 * Use the {@link FragmentViewPages198#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages198 extends Fragment {
    ...
    public static FragmentViewPages198 newInstance(String param1, String param2) {
        FragmentViewPages198 fragment = new FragmentViewPages198();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page198, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page198);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear198);
