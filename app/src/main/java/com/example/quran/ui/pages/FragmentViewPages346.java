 ...
 * Use the {@link FragmentViewPages346#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages346 extends Fragment {
    ...
    public static FragmentViewPages346 newInstance(String param1, String param2) {
        FragmentViewPages346 fragment = new FragmentViewPages346();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page346, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page346);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear346);
