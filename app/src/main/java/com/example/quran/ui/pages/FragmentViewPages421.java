 ...
 * Use the {@link FragmentViewPages421#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages421 extends Fragment {
    ...
    public static FragmentViewPages421 newInstance(String param1, String param2) {
        FragmentViewPages421 fragment = new FragmentViewPages421();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page421, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page421);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear421);
