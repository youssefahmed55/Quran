 ...
 * Use the {@link FragmentViewPages166#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages166 extends Fragment {
    ...
    public static FragmentViewPages166 newInstance(String param1, String param2) {
        FragmentViewPages166 fragment = new FragmentViewPages166();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page166, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page166);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear166);
