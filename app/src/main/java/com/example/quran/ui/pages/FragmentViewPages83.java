 ...
 * Use the {@link FragmentViewPages83#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages83 extends Fragment {
    ...
    public static FragmentViewPages83 newInstance(String param1, String param2) {
        FragmentViewPages83 fragment = new FragmentViewPages83();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page83, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page83);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear83);
