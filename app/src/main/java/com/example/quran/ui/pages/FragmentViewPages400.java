 ...
 * Use the {@link FragmentViewPages400#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages400 extends Fragment {
    ...
    public static FragmentViewPages400 newInstance(String param1, String param2) {
        FragmentViewPages400 fragment = new FragmentViewPages400();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page400, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page400);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear400);
