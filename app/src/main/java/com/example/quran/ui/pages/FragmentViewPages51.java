 ...
 * Use the {@link FragmentViewPages51#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages51 extends Fragment {
    ...
    public static FragmentViewPages51 newInstance(String param1, String param2) {
        FragmentViewPages51 fragment = new FragmentViewPages51();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page51, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page51);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear51);
