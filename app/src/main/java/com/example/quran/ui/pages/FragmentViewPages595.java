 ...
 * Use the {@link FragmentViewPages595#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages595 extends Fragment {
    ...
    public static FragmentViewPages595 newInstance(String param1, String param2) {
        FragmentViewPages595 fragment = new FragmentViewPages595();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page595, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear595);
        linearLayout2 = viewGroup.findViewById(R.id.linear595_2);
        s = getActivity().getResources().getString(R.string.page595);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page595_2);
        views.clear();
