 ...
 * Use the {@link FragmentViewPages581#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages581 extends Fragment {
    ...
    public static FragmentViewPages581 newInstance(String param1, String param2) {
        FragmentViewPages581 fragment = new FragmentViewPages581();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page581, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page581);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear581);
