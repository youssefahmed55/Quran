 ...
 * Use the {@link FragmentViewPages471#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages471 extends Fragment {
    ...
    public static FragmentViewPages471 newInstance(String param1, String param2) {
        FragmentViewPages471 fragment = new FragmentViewPages471();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page471, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page471);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear471);
