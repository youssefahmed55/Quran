 ...
 * Use the {@link FragmentViewPages180#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages180 extends Fragment {
    ...
    public static FragmentViewPages180 newInstance(String param1, String param2) {
        FragmentViewPages180 fragment = new FragmentViewPages180();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page180, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page180);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear180);
