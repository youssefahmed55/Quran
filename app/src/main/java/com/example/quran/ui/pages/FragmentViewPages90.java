 ...
 * Use the {@link FragmentViewPages90#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages90 extends Fragment {
    ...
    public static FragmentViewPages90 newInstance(String param1, String param2) {
        FragmentViewPages90 fragment = new FragmentViewPages90();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page90, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page90);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear90);
