 ...
 * Use the {@link FragmentViewPages442#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages442 extends Fragment {
    ...
    public static FragmentViewPages442 newInstance(String param1, String param2) {
        FragmentViewPages442 fragment = new FragmentViewPages442();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page442, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page442);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear442);
