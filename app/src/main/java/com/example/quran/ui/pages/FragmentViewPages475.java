 ...
 * Use the {@link FragmentViewPages475#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages475 extends Fragment {
    ...
    public static FragmentViewPages475 newInstance(String param1, String param2) {
        FragmentViewPages475 fragment = new FragmentViewPages475();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page475, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page475);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear475);
