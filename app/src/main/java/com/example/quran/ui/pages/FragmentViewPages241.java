 ...
 * Use the {@link FragmentViewPages241#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages241 extends Fragment {
    ...
    public static FragmentViewPages241 newInstance(String param1, String param2) {
        FragmentViewPages241 fragment = new FragmentViewPages241();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page241, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page241);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear241);
