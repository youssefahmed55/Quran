 ...
 * Use the {@link FragmentViewPages206#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages206 extends Fragment {
    ...
    public static FragmentViewPages206 newInstance(String param1, String param2) {
        FragmentViewPages206 fragment = new FragmentViewPages206();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page206, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page206);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear206);
