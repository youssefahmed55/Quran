 ...
 * Use the {@link FragmentViewPages175#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages175 extends Fragment {
    ...
    public static FragmentViewPages175 newInstance(String param1, String param2) {
        FragmentViewPages175 fragment = new FragmentViewPages175();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page175, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page175);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear175);
