 ...
 * Use the {@link FragmentViewPages368#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages368 extends Fragment {
    ...
    public static FragmentViewPages368 newInstance(String param1, String param2) {
        FragmentViewPages368 fragment = new FragmentViewPages368();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page368, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page368);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear368);
