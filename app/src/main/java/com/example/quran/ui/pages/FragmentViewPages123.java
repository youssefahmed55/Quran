 ...
 * Use the {@link FragmentViewPages123#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages123 extends Fragment {
    ...
    public static FragmentViewPages123 newInstance(String param1, String param2) {
        FragmentViewPages123 fragment = new FragmentViewPages123();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page123, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page123);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear123);
