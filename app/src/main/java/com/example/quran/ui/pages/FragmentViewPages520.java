 ...
 * Use the {@link FragmentViewPages520#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages520 extends Fragment {
    ...
    public static FragmentViewPages520 newInstance(String param1, String param2) {
        FragmentViewPages520 fragment = new FragmentViewPages520();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page520, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear520);
        linearLayout2 = viewGroup.findViewById(R.id.linear520_2);
        s = getActivity().getResources().getString(R.string.page520);
        ...
        i = 1 ;
        s=  s=getActivity().getResources().getString(R.string.page520_2);
        views.clear();
