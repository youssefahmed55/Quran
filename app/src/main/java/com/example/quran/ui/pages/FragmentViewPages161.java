 ...
 * Use the {@link FragmentViewPages161#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages161 extends Fragment {
    ...
    public static FragmentViewPages161 newInstance(String param1, String param2) {
        FragmentViewPages161 fragment = new FragmentViewPages161();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page161, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page161);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear161);
