 ...
 * Use the {@link FragmentViewPages296#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages296 extends Fragment {
    ...
    public static FragmentViewPages296 newInstance(String param1, String param2) {
        FragmentViewPages296 fragment = new FragmentViewPages296();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page296, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page296);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear296);
