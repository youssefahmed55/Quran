 ...
 * Use the {@link FragmentViewPages7#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages7 extends Fragment {
    ...
    public static FragmentViewPages7 newInstance(String param1, String param2) {
        FragmentViewPages7 fragment = new FragmentViewPages7();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page7, container, false);
        handleViews();
        return viewGroup;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page7);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear7);
