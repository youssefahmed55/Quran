 ...
 * Use the {@link FragmentViewPages47#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages47 extends Fragment {
    ...
    public static FragmentViewPages47 newInstance(String param1, String param2) {
        FragmentViewPages47 fragment = new FragmentViewPages47();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page47, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page47);
        ...
        for (String word : s.split(" ")){
            ...
            switch (i){
                case 45 :
                    ...
                    imageView.setImageResource(R.drawable.num275);
                    views.add(imageView);
                    break;
                case 56 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num276);
                    views.add(imageView);
                    break;
                case 75 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num277);
                    views.add(imageView);
                    break;
                case 89 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num278);
                    views.add(imageView);
                    break;
                case 106 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num279);
                    views.add(imageView);
                    break;
                case 120 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num280);
                    views.add(imageView);
                    break;
                case 135 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num281);
                    views.add(imageView);
                    break;
        ...
        linearLayout = viewGroup.findViewById(R.id.linear47);
