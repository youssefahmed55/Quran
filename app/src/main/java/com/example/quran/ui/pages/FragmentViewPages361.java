 ...
 * Use the {@link FragmentViewPages361#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages361 extends Fragment {
    ...
    public static FragmentViewPages361 newInstance(String param1, String param2) {
        FragmentViewPages361 fragment = new FragmentViewPages361();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page361, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page361);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear361);
