 ...
 * Use the {@link FragmentViewPages473#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages473 extends Fragment {
    ...
    public static FragmentViewPages473 newInstance(String param1, String param2) {
        FragmentViewPages473 fragment = new FragmentViewPages473();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page473, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page473);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear473);
