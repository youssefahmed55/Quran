 ...
 * Use the {@link FragmentViewPages375#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages375 extends Fragment {
    ...
    public static FragmentViewPages375 newInstance(String param1, String param2) {
        FragmentViewPages375 fragment = new FragmentViewPages375();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page375, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page375);
        ...
        for (String word : s.split(" ")){
            ...
            switch (i){
                case 5 :
                    ...
                    imageView.setImageResource(R.drawable.num184);
                    views.add(imageView);
                    break;
                case 10 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num185);
                    views.add(imageView);
                    break;
                case 19 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num186);
                    views.add(imageView);
                    break;
                case 28 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num187);
                    views.add(imageView);
                    break;
                case 33 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num188);
                    views.add(imageView);
                    break;
                case 43 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num189);
                    views.add(imageView);
                    break;
                case 51 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num190);
                    views.add(imageView);
                    break;
                case 56 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num191);
                    views.add(imageView);
                    break;
                case 60 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num192);
                    views.add(imageView);
                    break;
                case 64 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num193);
                    views.add(imageView);
                    break;
                case 69 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num194);
                    views.add(imageView);
                    break;
                case 72 :
                    imageView = new ImageView(getActivity());
                    imageView.setImageResource(R.drawable.num195);
                    views.add(imageView);
                    break;
                case 76 :
                    imageView = new ImageView(getActivity());
        ...
        linearLayout = viewGroup.findViewById(R.id.linear375);
