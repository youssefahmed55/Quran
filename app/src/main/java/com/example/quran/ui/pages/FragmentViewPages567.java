 ...
 * Use the {@link FragmentViewPages567#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages567 extends Fragment {
    ...
    public static FragmentViewPages567 newInstance(String param1, String param2) {
        FragmentViewPages567 fragment = new FragmentViewPages567();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page567, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page567);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear567);
