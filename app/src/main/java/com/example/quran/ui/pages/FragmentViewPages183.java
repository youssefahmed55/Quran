 ...
 * Use the {@link FragmentViewPages183#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages183 extends Fragment {
    ...
    public static FragmentViewPages183 newInstance(String param1, String param2) {
        FragmentViewPages183 fragment = new FragmentViewPages183();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page183, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page183);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear183);
