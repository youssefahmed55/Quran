 ...
 * Use the {@link FragmentViewPages261#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages261 extends Fragment {
    ...
    public static FragmentViewPages261 newInstance(String param1, String param2) {
        FragmentViewPages261 fragment = new FragmentViewPages261();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page261, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page261);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear261);
