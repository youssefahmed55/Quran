 ...
 * Use the {@link FragmentViewPages524#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages524 extends Fragment {
    ...
    public static FragmentViewPages524 newInstance(String param1, String param2) {
        FragmentViewPages524 fragment = new FragmentViewPages524();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page524, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page524);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear524);
