 ...
 * Use the {@link FragmentViewPages294#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages294 extends Fragment {
    ...
    public static FragmentViewPages294 newInstance(String param1, String param2) {
        FragmentViewPages294 fragment = new FragmentViewPages294();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page294, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page294);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear294);
