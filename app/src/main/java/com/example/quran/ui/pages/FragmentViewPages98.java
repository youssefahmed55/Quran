 ...
 * Use the {@link FragmentViewPages98#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages98 extends Fragment {
    ...
    public static FragmentViewPages98 newInstance(String param1, String param2) {
        FragmentViewPages98 fragment = new FragmentViewPages98();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page98, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page98);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear98);
