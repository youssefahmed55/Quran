 ...
 * Use the {@link FragmentViewPages443#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages443 extends Fragment {
    ...
    public static FragmentViewPages443 newInstance(String param1, String param2) {
        FragmentViewPages443 fragment = new FragmentViewPages443();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page443, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page443);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear443);
