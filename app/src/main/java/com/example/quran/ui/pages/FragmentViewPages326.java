 ...
 * Use the {@link FragmentViewPages326#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages326 extends Fragment {
    ...
    public static FragmentViewPages326 newInstance(String param1, String param2) {
        FragmentViewPages326 fragment = new FragmentViewPages326();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page326, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page326);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear326);
