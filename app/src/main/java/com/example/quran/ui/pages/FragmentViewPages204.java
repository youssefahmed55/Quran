 ...
 * Use the {@link FragmentViewPages204#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages204 extends Fragment {
    ...
    public static FragmentViewPages204 newInstance(String param1, String param2) {
        FragmentViewPages204 fragment = new FragmentViewPages204();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page204, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page204);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear204);
