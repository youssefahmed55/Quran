 ...
 * Use the {@link FragmentViewPages106#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages106 extends Fragment {
    ...
    public static FragmentViewPages106 newInstance(String param1, String param2) {
        FragmentViewPages106 fragment = new FragmentViewPages106();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page106, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        linearLayout = viewGroup.findViewById(R.id.linear106);
        linearLayout2 = viewGroup.findViewById(R.id.linear106_2);
        s = getActivity().getResources().getString(R.string.page106);
        ...
        s=getActivity().getResources().getString(R.string.page106_2);
        i = 1 ;
        views.clear();
        for (String word : s.split(" ")){
            textView = new TextView(getActivity());
