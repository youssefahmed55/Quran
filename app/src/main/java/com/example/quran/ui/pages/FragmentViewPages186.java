 ...
 * Use the {@link FragmentViewPages186#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages186 extends Fragment {
    ...
    public static FragmentViewPages186 newInstance(String param1, String param2) {
        FragmentViewPages186 fragment = new FragmentViewPages186();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page186, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page186);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear186);
