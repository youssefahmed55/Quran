 ...
 * Use the {@link FragmentViewPages503#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages503 extends Fragment {
    ...
    public static FragmentViewPages503 newInstance(String param1, String param2) {
        FragmentViewPages503 fragment = new FragmentViewPages503();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page503, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page503);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear503);
