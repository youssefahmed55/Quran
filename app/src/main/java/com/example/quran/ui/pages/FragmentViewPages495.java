 ...
 * Use the {@link FragmentViewPages495#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages495 extends Fragment {
    ...
    public static FragmentViewPages495 newInstance(String param1, String param2) {
        FragmentViewPages495 fragment = new FragmentViewPages495();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page495, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page495);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear495);
