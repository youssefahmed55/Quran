 ...
 * Use the {@link FragmentViewPages114#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages114 extends Fragment {
    ...
    public static FragmentViewPages114 newInstance(String param1, String param2) {
        FragmentViewPages114 fragment = new FragmentViewPages114();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page114, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page114);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear114);
