 ...
 * Use the {@link FragmentViewPages512#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages512 extends Fragment {
    ...
    public static FragmentViewPages512 newInstance(String param1, String param2) {
        FragmentViewPages512 fragment = new FragmentViewPages512();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page512, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page512);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear512);
