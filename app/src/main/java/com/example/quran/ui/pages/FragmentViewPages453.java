 ...
 * Use the {@link FragmentViewPages453#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages453 extends Fragment {
    ...
    public static FragmentViewPages453 newInstance(String param1, String param2) {
        FragmentViewPages453 fragment = new FragmentViewPages453();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page453, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page453);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear453);
