 ...
 * Use the {@link FragmentViewPages272#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages272 extends Fragment {
    ...
    public static FragmentViewPages272 newInstance(String param1, String param2) {
        FragmentViewPages272 fragment = new FragmentViewPages272();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page272, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page272);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear272);
