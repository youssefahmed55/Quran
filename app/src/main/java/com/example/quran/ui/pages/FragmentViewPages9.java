 ...
 * Use the {@link FragmentViewPages9#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages9 extends Fragment {
    ...
    public static FragmentViewPages9 newInstance(String param1, String param2) {
        FragmentViewPages9 fragment = new FragmentViewPages9();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page9, container, false);
        handleViews();
        return  viewGroup;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page9);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear9);
