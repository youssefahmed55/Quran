 ...
 * Use the {@link FragmentViewPages269#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages269 extends Fragment {
    ...
    public static FragmentViewPages269 newInstance(String param1, String param2) {
        FragmentViewPages269 fragment = new FragmentViewPages269();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page269, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page269);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear269);
