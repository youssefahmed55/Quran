 ...
 * Use the {@link FragmentViewPages78#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages78 extends Fragment {
    ...
    public static FragmentViewPages78 newInstance(String param1, String param2) {
        FragmentViewPages78 fragment = new FragmentViewPages78();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page78, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page78);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear78);
