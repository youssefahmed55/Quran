 ...
 * Use the {@link FragmentViewPages52#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages52 extends Fragment {
    ...
    public static FragmentViewPages52 newInstance(String param1, String param2) {
        FragmentViewPages52 fragment = new FragmentViewPages52();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page52, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page52);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear52);
