 ...
 * Use the {@link FragmentViewPages199#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentViewPages199 extends Fragment {
    ...
    public static FragmentViewPages199 newInstance(String param1, String param2) {
        FragmentViewPages199 fragment = new FragmentViewPages199();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewGroup = (ViewGroup) inflater.inflate(R.layout.page199, container, false);
        handleViews();
        return viewGroup ;
    }
    ...
    private void handleViews(){
        ...
        s = getActivity().getResources().getString(R.string.page199);
        ...
        linearLayout = viewGroup.findViewById(R.id.linear199);
